...
Forslag (mit bud, DA):
- Label: `BETA ÅBEN`
- Tekst: `Book en demo og prøv platformen med jeres eget hold`
- Knap: `Book demo →` (linker til /contact i stedet for /auth?tab=signup)

Alternativer hvis du hellere vil beholde prøveperiode-vinklen:
- "Se platformen live — book en uforpligtende demo"
- "Nysgerrig? Kontakt os om demo og prøveperiode"
