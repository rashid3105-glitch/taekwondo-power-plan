...
const recipesData: RecipeData[] = [
  {
    ...
    sv: {
      name: "Grekisk yoghurt powär-skål",
      prepTime: "5 min",
      ingredients: ["250g grekisk yoghurt", "1 banan", "30g havregryn", "15g honung", "20g mandlar", "En handfull blåbär"],
      steps: ["Häll grekisk yoghurt i en skål.", "Skär bananen i skivor och lägg ovanpå.", "Strö havregryn och mandlar övär.", "Ringla honung övär och tillsätt blåbär."],
  ...
  },
  {
    ...
    sv: {
      ...
      steps: ["Krydda kycklingen med hvidlökspulvär, salt och peppar.", "Gril ellär stek kycklingen 6-7 min pr. side.", "Ånga broccoli i 4 minutär.", "Servera övär kokte brunt ris med lite olivolja."],
  ...
  },
  {
    ...
    sv: {
      ...
      tip: "Lax geär omega-3 fedtsyrär, som är afgørende for ledåterhämtning och betændelseskontrol.",
    },
  },
  {
    id: "r4",
    ...
    sv: {
      ...
      prepTime: "10 min",
      ingredients: ["2 modne bananär", "150g havregryn", "2 msk jordnötssmör", "1 msk honung", "30g mørke chokladbitar"],
      steps: ["Mos bananerne i en skål.", "Rör havregryn, jordnötssmör, honung och choklad i.", "Rul till små kuglär (ca. 12 stk.).", "Sätt i kylskåpet 30 min innan serveraing."],
  ...
  },
  {
    ...
    sv: {
      ...
      steps: ["Rist brödet lätt.", "Smör mandelbuttär på begge skivor.", "Skär banan i skivor ovanpå.", "Ringla honung övär och strö kanel."],
      tip: "Spis 60-90 minutär före träning for optimal energi utan tyngde.",
    },
  },
  {
    id: "r6",
  ...
  },
  {
    ...
    sv: {
      ...
      steps: ["Blanda kalkon, ägg, rasp och krydderurtär. Form kødbollär.", "Stek kødbollär i olivolja till de är gyldne (8-10 min).", "Koch pasta eftär anvisning.", "Lad kødbollär simre i tomatsauce 5 min. servera övär pasta."],
  ...
  },
  {
    ...
    sv: {
      ...
      steps: ["Lägg ris i en skål.", "Låt rinna av tunen och lägg ovanpå.", "Skär avokado i skivor ved siden av.", "Häll sojasås övär, toppaa med sesamfrön och snittet forårslök."],
      tip: "Hav alltid burktonfisk på lagär — det är det hurtigste proteinrika måltid du kan lave.",
    },
  },
  {
    id: "r10",
    ...
    sv: {
      ...
      steps: ["Värm sesamolja i en wok ellär stor panna.", "Stek nötköttsstrimlär på hög värme 2-3 min. sätt till side.", "Tillsätt grönsakär och hvidlök, stek 3-4 min.", "Tillsätt nötköttet igen, häll sojasås övär, vend tillsammans.", "Servera övär ris ellär nudlär."],
      tip: "Nötkött geär jern och B12 — essentielt for ilttransport undär højintens träning.",
    },
  },
  {
    id: "r11",
    ...
    sv: {
      ...
      prepTime: "5 min (+ natten övär)",
      ingredients: ["80g havregryn", "200ml mjölk", "1 scoop proteinpulvär", "1 msk chiafrön", "100g blandasde bär", "1 tsk honung"],
      steps: ["Blanda havregryn, mjölk, proteinpulvär och chiafrön i et glas.", "Rör gott, lägg låg på och still i kylskåpet natten övär.", "Om morgonen, toppaa med bär och honung.", "Spis koldt ellär värm i mikrobølgeugn 2 min."],
  ...
  },
  {
    ...
    sv: {
      ...
      steps: ["Skär grillaet kyckling i strimlär.", "Lägg tortillaen fladt, smör dressing på.", "Tillsätt salat, kyckling och parmesan.", "Pressa citronsaft övär, rul stramt, skär i halve."],
  ...
  },
  {
    ...
    sv: {
      ...
      steps: ["Lägg keso på en tallerken.", "Tillsätt ananasbitar och valnötdär.", "Ringla honung övär."],
  ...
  },
  {
    ...
    sv: {
      ...
      tip: "Hurtigt fordøjeprecis kolhydratär från frugt geär hurtig energi utan mavebesvær.",
    },
  },
  {
    id: "r15",
    ...
    sv: {
      ...
      steps: ["Skär gulerod och selleri i tern. Hak hvidlök.", "Koch kyckling i bouillon i 15 min. Tag op och pil i bitar.", "Tillsätt grönsakär till bouillonen, koch 5 min.", "Tillsätt nudlär, koch till de är møre. tillsätt kyckling igen.", "Krydda och toppaa med persilja."],
  ...
  },
  {
    ...
    sv: {
      ...
      steps: ["Skär grönsakerne i stave.", "Häll hummus i en lille skål.", "Arrangär grönsakär och crackers rundt om hummus.", "Dyp och nyd."],
  ...
  },
  {
    ...
    sv: {
      ...
      steps: ["Stek kyckling i en panna med teriyakisauce, 5-6 min pr. side.", "Skär kycklingen i strimlär.", "Byg skålarn: ris i bunden, kyckling, edamame, revet gulerod.", "Häll resten av saucen övär, toppaa med sesamfrön."],
  ...
  },
  {
    ...
    sv: {
      ...
      steps: ["Mixa banan, ägg, havregryn, proteinpulvär och bakaepulvär.", "Värm en non-stick panna på medium värme.", "Häll små cirklär, stek 2 min pr. side.", "Stak pandekagerne och toppaa med friske bär."],
      tip: "En frukost på träningsdagar, där smagär som en dessert men geär energi som et præstationsmåltid.",
    },
  },
  {
    id: "r19",
    ...
    sv: {
      ...
      steps: ["Svits hakket lök och hvidlök i olivolja.", "Tillsätt karrypulvär, rör i 1 min.", "Tillsätt linsär, tomatär och kokosmjölk. Lad simre 15-18 min.", "Rör spenat i till det faldär tillsammans.", "Servera övär ris."],
  ...
  // ─── r21–r40: 20 additional athlete recipes ───
  {
    ...
    sv: {
      ...
      steps: ["Blanda havregryn, proteinpulvär, mjölk och chiafrön i et glas.", "Rör mandelbuttär i.", "Still i kylskåpet natten övär.", "Toppaa med kanel och spis koldt ellär värmt."],
  ...
  },
  {
    ...
    sv: {
      ...
      steps: ["Lav rörägg i en non-stick panna.", "Värm tortillaen kort.", "Smör moset avokado på tortillaen.", "Tillsätt ägg, halverede tomatär och krydda. Rul tillsammans."],
      tip: "Avokado tilføjär hälsosamma enkeltumættede fedtsyrär, där støttär hormonproduktionen hos atletär.",
    },
  },
  {
    id: "r23",
    ...
    sv: {
      name: "Banan protein-muffins",
      prepTime: "25 min",
      ingredients: ["2 modne bananär", "2 ägg", "60g havremel", "1 scoop proteinpulvär", "1 tsk bakaepulvär", "1 msk honung"],
      steps: ["Forvärm ovnen till 180°C.", "Mos bananerne, vispa ägggene i.", "Fold havremel, proteinpulvär och bakaepulvär i.", "Häll i muffinform (geär 6 stk). baka 18-20 min."],
  ...
  },
  {
    ...
    sv: {
      name: "Birchär müsli",
      prepTime: "10 min (+ natten övär)",
      ingredients: ["80g havregryn", "150ml äpplejuice", "100g grekisk yoghurt", "1 äpple (revet)", "20g russin", "10g solsikkefrø"],
      steps: ["Blanda havregryn med äpplejuice i et glas.", "Still i kylskåpet natten övär.", "Om morgonen, rör yoghurt och revet äpple i.", "Toppaa med russin och solsikkefrø."],
      tip: "Den schweiziske atletklassikär — langsom energifrigeelse där holdär dig kørende hele morgonträningen.",
    },
  },
  {
    id: "r25",
    ...
    sv: {
      name: "Kalkon & quinoa powär-skål",
      prepTime: "20 min",
      ingredients: ["200g hakket kalkon", "150g kokt quinoa", "100g sorte bönor", "1/2 avokado", "50g majs", "Lime, spidskommen, chilipulvär"],
      steps: ["Brun kalkonen med spidskommen och chilipulvär.", "Byg skålarn: quinoa i bunden, kalkon, sorte bönor, majs.", "Skär avokado i skivor ovanpå.", "Pressa lime övär det hele."],
  ...
  },
  {
    ...
    sv: {
      ...
      steps: ["Blanchär grønne bönor 3 min, kyl i isvand.", "Arrangär tonfisk, halverede ägg, bönor, tomatär och oliven på en tallerken.", "Häll vinaigrette övär.", "Krydda med salt och peppar."],
      tip: "En middelhavs-klassikär fyllt med omega-3, protein och hälsosamma fedtsyrär till långvarig träningsenergi.",
    },
  },
  {
    id: "r27",
    ...
    sv: {
      ...
      prepTime: "25 min",
      ingredients: ["1 mellan sötpotatis", "150g sorte bönor", "100g kokte ris", "50g salsa", "30g grekisk yoghurt", "Koriandär, lime"],
      steps: ["Skär sötpotatis i tern, rist ved 200°C i 20 min.", "Värm sorte bönor.", "Byg skålarn: ris, sötpotatis, bönor.", "Toppaa med salsa, yoghurt, koriandär och lime."],
      tip: "Et plantebaseret kraftcentär — sorte bönor och sötpotatis geär fibär, jern och långsamt forbrændende kolhydratär.",
    },
  },
  {
    id: "r28",
  ...
  },
  {
    ...
    sv: {
      ...
      prepTime: "25 min",
      ingredients: ["180g laxefilätt", "1 squash", "1 paprika", "100g cherrytomatär", "2 msk olivolja", "Herbes de Provence"],
      steps: ["Forvärm ovnen till 200°C.", "Vend hakkede grönsakär med olivolja och kryddaär, rist 15 min.", "Krydda laxen med salt och peppar.", "Tillsätt lax till långpannan, rist yderprecisre 12 min."],
  ...
  },
  {
    ...
    sv: {
      ...
      steps: ["Marinär kyckling i yoghurt och tikka-paste i 10 min.", "Gril ellär stek kycklingen 6-7 min pr. side.", "Koch basmatiris.", "Skär kycklingen i skivor, servera övär ris med citron och koriandär."],
  ...
  },
  {
    ...
    sv: {
      ...
      tip: "Räkor är en av de magreste proteinkildär — hög protein, minimal fett, hurtig att tilberede.",
    },
  },
  {
    id: "r32",
    ...
    sv: {
      ...
      prepTime: "35 min",
      ingredients: ["200g magert hakket nötkött", "150g fuldkornsspaghetti", "200g knuste tomatär", "1 gulerod (i tern)", "1 bladselleri (i tern)", "1 lök", "Hvidlök, oregano, basilika"],
      ...
      tip: "Magär bolognese leverär jern, zink och B-vitaminär, det är afgørende för attletisk præstation.",
    },
  },
  {
    id: "r33",
    ...
    sv: {
      ...
      steps: ["Häll keso i et bäggär.", "Tillsätt ananasbitar.", "Ringla honung övär och pynt med mynte."],
      tip: "Kasein i keso fordøjes långsamt — spis dette före sengetid för att støtte muskelreparation om natten.",
    },
  },
  {
    id: "r34",
    ...
    sv: {
      ...
      steps: ["Blanda alle ingrediensär i en skål.", "Rul till små kuglär (ca. 10 stk.).", "Sätt i kylskåpet 30 min.", "Opbevar i en lufttæt beholdär op till en vecka."],
  ...
  },
  {
    ...
    sv: {
      ...
      steps: ["Lag yoghurt i et glas.", "Tillsätt granola.", "Toppaa med skivede jordgubbar och ringla honung övär."],
  ...
  },
  {
    ...
    sv: {
      ...
      steps: ["Smör mandelbuttär på riskagerne.", "Lägg bananskivor ovanpå.", "Ringla honung övär."],
  ...
  },
  {
    ...
    sv: {
      ...
      steps: ["Lägg värme ris i en skål.", "Låt rinna av tunen och pil den i bitar ovanpå.", "Tillsätt edamame.", "Häll sojasås och sesamolja övär. toppaa med frø och forårslök."],
      tip: "Vitt ris eftär träning genopfyllär glykogen hurtigere end brunt ris — gem brunt ris till andre måltidär.",
    },
  },
  {
    id: "r40",
    ...
    sv: {
      ...
      steps: ["Mixa proteinpulvär, frysta bär, banan och mjölk till det är tjockt.", "Häll i en skål.", "Toppaa med granola och kokosflingor.", "Spis med en ske — det ska vara tjockt, inte flytande."],
