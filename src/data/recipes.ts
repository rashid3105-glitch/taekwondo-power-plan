...
const recipesData: RecipeData[] = [
  ...
  },
  {
    ...
    no: {
      ...
      steps: ["Mos bananerne i en bolle.", "Rør havregryn, peanøttsmør, honning og sjokolade i.", "Rul til små kugler (ca. 12 stk.).", "Sett i kjøleskapet 30 min før servering."],
      tip: "Perfekt hurtig energi 1 time før trening.",
    },
    sv: {
      name: "Banan-havre energikuglär",
      prepTime: "10 min",
      ingredients: ["2 mogna bananär", "150g havregryn", "2 msk jordnötssmör", "1 msk honung", "30g mörka chokladbitar"],
      steps: ["Mosa bananerna i en skål.", "Rör havregryn, jordnötssmör, honung och choklad i.", "Rulla till små kuglär (ca. 12 st.).", "Sätt i kylskåpet 30 min innan serveraing."],
  ...
  },
  {
    ...
    no: {
      ...
      prepTime: "5 min",
      ingredients: ["2 skiver fullkornsbrød", "1 ss mandelbutter", "1 banan", "Litt honning", "Et drys kanel"],
      steps: ["Rist brødet lett.", "Smør mandelbutter på begge skiver.", "Skjær banan i skiver oppå.", "Drypp honning over og drys kanel."],
      tip: "Spis 60-90 minutter før trening for optimal energi uten tyngde.",
    },
    sv: {
      name: "Före-träning toast",
      prepTime: "5 min",
      ingredients: ["2 skivor fullkornsbröd", "1 msk mandelbuttär", "1 banan", "Lite honung", "Et strö kanel"],
      steps: ["Rist brödet lätt.", "Smör mandelbuttär på begge skivor.", "Skär banan i skivor ovanpå.", "Ringla honung över och strö kanel."],
  ...
  },
  {
    ...
    sv: {
      name: "Protein-shake eftär träning",
      prepTime: "3 min",
      ingredients: ["1 scoop valleprotein", "1 banan", "200ml mjölk", "1 msk havregryn", "1 msk jordnötssmör", "Isterningär"],
      steps: ["Tillsätt alle ingrediensär i en mixär.", "Mixa till det är glat (30 sekunder).", "Drik innan för 30 minuter eftär träning."],
      tip: "2:1 kolhydrat-till-protein forholdet är optimalt for återhämtning eftär intense sessionär.",
    },
  },
  {
    id: "r7",
    ...
    sv: {
      ...
      steps: ["Blanda kalkon, ägg, rasp och krydderurtär. Form kødbollär.", "Stek kødbollär i olivolja till de är gyldne (8-10 min).", "Koch pasta eftär anvisning.", "Lad kødbollär simre i tomatsauce 5 min. Servera över pasta."],
  ...
  },
  {
    ...
    sv: {
      ...
      steps: ["Värm olivolja i en panna.", "Svits hakket peppar och spenat i 2 min.", "Vispa ägggene, häll i panden och rör försiktigt.", "Toppaa med smuldret feta. krydda och servera."],
      tip: "ägg indeholdär alle essentielle aminosyrär — den perfekte proteinkilde för attletär.",
    },
  },
  {
    id: "r9",
    ...
    no: {
      ...
      steps: ["Legg ris i en bolle.", "Drener tunen og legg oppå.", "Skjær avokado i skiver ved siden av.", "Hell soyasaus over, topp med sesamfrø og snittet forårsløk."],
    ...
    sv: {
      ...
      steps: ["Lägg ris i en skål.", "Låt rinna av tunen och lägg ovanpå.", "Skär avokado i skivor ved siden av.", "Häll sojasås över, toppaa med sesamfrön och snittet forårslök."],
  ...
  },
  {
    ...
    sv: {
      ...
      steps: ["Blanda havregryn, mjölk, proteinpulver och chiafrön i et glas.", "Rör gott, lägg låg på och still i kylskåpet natten över.", "Om morgonen, toppaa med bär och honung.", "Ät koldt eller värm i mikrobølgeugn 2 min."],
      tip: "Förbered 3-4 glas søndag kväll till ubesværede morgonmåltidär i hverdagarn.",
    },
  },
  {
    id: "r12",
  ...
  },
  {
    ...
    sv: {
      ...
      tip: "Keso är rig på kaseinprotein — ideel till langsom energifrigeelse mellan måltidär.",
    },
  },
  {
    id: "r14",
  ...
  },
  {
    ...
    sv: {
      ...
      steps: ["Skär gulerod och selleri i tärningar. Hak hvidlök.", "Koch kyckling i bouillon i 15 min. Tag op och pil i bitar.", "Tillsätt grönsakär till bouillonen, koch 5 min.", "Tillsätt nudlär, koch till de är møre. tillsätt kyckling igen.", "Krydda och toppaa med persilja."],
      tip: "Värm suppe rehydrerär, genopfyllär natrium och leverär protein — det ultimative återhämtningsmåltid.",
    },
  },
  {
    id: "r16",
  ...
  },
  {
    ...
    no: {
      ...
      steps: ["Stek kylling i en panne med teriyakisauce, 5-6 min per side.", "Skjær kyllingen i strimler.", "Byg bolleen: ris i bunden, kylling, edamame, revet gulerod.", "Hell resten av saucen over, topp med sesamfrø."],
    ...
    sv: {
      ...
      steps: ["Stek kyckling i en panna med teriyakisauce, 5-6 min per sida.", "Skär kycklingen i strimlär.", "Byg skålarn: ris i bunden, kyckling, edamame, revet gulerod.", "Häll resten av saucen över, toppaa med sesamfrön."],
      tip: "Jasminris fordøjes snabbt — perfekt till att genopfylle glykogenlagrene eftär morgonträning.",
    },
  },
  {
    id: "r18",
    ...
    sv: {
      ...
      steps: ["Mixa banan, ägg, havregryn, proteinpulver och bakaepulver.", "Värm en non-stick panna på medium värme.", "Häll små cirklär, stek 2 min per sida.", "Stak pandekagerne och toppaa med frisked bär."],
  ...
  },
  {
    ...
    sv: {
      name: "Chokladmjölk-återhämtning eftär träning",
      prepTime: "2 min",
      ingredients: ["400ml sødmjölk", "2 msk kakaopulver", "1 msk honung", "Et strö salt"],
      steps: ["Värm mjölken lätt (eller använd kold).", "Vispa kakaopulver, honung och salt i.", "Drik innan för 30 minuter eftär träning."],
      tip: "Forskning visär, at chokladmjölk matchär dyre återhämtningsdrikke till genopfyllning av glykogen eftär träning.",
    },
  },
  // ─── r21–r40: 20 additional athlete recipes ───
  {
    ...
    sv: {
      name: "Overnight protein-havregryn",
      prepTime: "5 min (+ natten över)",
      ingredients: ["80g havregryn", "1 scoop vanilje proteinpulver", "200ml mandelmjölk", "1 msk chiafrön", "1 msk mandelbuttär", "Kanel"],
      steps: ["Blanda havregryn, proteinpulver, mjölk och chiafrön i et glas.", "Rör mandelbuttär i.", "Still i kylskåpet natten över.", "Toppaa med kanel och ät koldt eller värmt."],
  ...
  },
  {
    ...
    sv: {
      name: "Banan protein-muffins",
      prepTime: "25 min",
      ingredients: ["2 mogna bananär", "2 ägg", "60g havremel", "1 scoop proteinpulver", "1 tsk bakaepulver", "1 msk honung"],
  ...
  },
  {
    ...
    no: {
      ...
      steps: ["Brun kalkunen med spidskommen og chilipulver.", "Byg bolleen: quinoa i bunden, kalkun, sorte bønner, majs.", "Skjær avokado i skiver oppå.", "Press lime over det hele."],
  ...
  },
  {
    ...
    no: {
      ...
      steps: ["Skjær søtpotet i terninger, rist ved 200°C i 20 min.", "Varm sorte bønner.", "Byg bolleen: ris, søtpotet, bønner.", "Topp med salsa, yoghurt, koriander og lime."],
    ...
    sv: {
      ...
      steps: ["Skär sötpotatis i tärningar, rist ved 200°C i 20 min.", "Värm sorte bönor.", "Byg skålarn: ris, sötpotatis, bönor.", "Toppaa med salsa, yoghurt, koriandär och lime."],
  ...
  },
  {
    ...
    no: {
      name: "Trail mix energikugler",
      prepTime: "10 min",
      ingredients: ["100g havregryn", "60g blandesde nødder (knuste)", "40g tørkede tranebær", "2 ss honning", "2 ss kokosolje (smeltet)", "1 ss kakaopulver"],
    ...
    sv: {
      ...
      steps: ["Blanda alle ingrediensär i en skål.", "Rulla till små kuglär (ca. 10 st.).", "Sätt i kylskåpet 30 min.", "Opbevar i en lufttæt beholdär op till en vecka."],
  ...
  },
  {
    ...
    no: {
      name: "Riskager med mandelbutter & banan",
      prepTime: "3 min",
      ingredients: ["2 riskager", "2 ss mandelbutter", "1 banan (i skiver)", "Litt honning"],
      steps: ["Smør mandelbutter på riskagerne.", "Legg bananskiver oppå.", "Drypp honning over."],
      tip: "Lett, raskt fordøjeligt og energitæt — det ideelle brændstof 45 min før sparring.",
    },
    sv: {
      name: "Riskagär med mandelbuttär & banan",
      prepTime: "3 min",
      ingredients: ["2 riskagär", "2 msk mandelbuttär", "1 banan (i skivor)", "Lite honung"],
      steps: ["Smör mandelbuttär på riskagerne.", "Lägg bananskivor ovanpå.", "Ringla honung över."],
  ...
  },
  {
    ...
    no: {
      ...
      steps: ["Legg varme ris i en bolle.", "Drener tunen og pil den i biter oppå.", "Tilsett edamame.", "Hell soyasaus og sesamolje over. topp med frø og forårsløk."],
    ...
    sv: {
      ...
      prepTime: "10 min",
      ingredients: ["1 burk tonfisk (i vand)", "150g kokt vitt ris", "50g edamame", "1 msk sojasås", "1 tsk sesamolja", "Sesamfrön, forårslök"],
      steps: ["Lägg värme ris i en skål.", "Låt rinna av tunen och pil den i bitar ovanpå.", "Tillsätt edamame.", "Häll sojasås och sesamolja över. toppaa med frø och forårslök."],
      tip: "Vitt ris eftär träning genopfyllär glykogen snabbere end brunt ris — gem brunt ris till andre måltidär.",
    },
  },
  {
    id: "r40",
    ...
    sv: {
      ...
      prepTime: "5 min",
      ingredients: ["1 scoop proteinpulver", "100g frysta blandasde bär", "1 banan", "100ml mjölk", "30g granola", "1 msk kokosflingor"],
      steps: ["Mixa proteinpulver, frysta bär, banan och mjölk till det är tjockt.", "Häll i en skål.", "Toppaa med granola och kokosflingor.", "Ät med en sked — det ska vara tjockt, inte flytande."],
      tip: "Frosne bär gör smoothie-skålarn tjock och is-agtig — den perfekte belønning eftär träning.",
    },
  },
];
