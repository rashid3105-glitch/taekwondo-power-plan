...
const recipesData: RecipeData[] = [
  {
    ...
    sv: {
      ...
      tip: "Använd fetrik yoghurt for långvarig energi på hårde träningsdagar.",
    },
  },
  {
    id: "r2",
    ...
    no: {
      ...
      steps: ["Krydre kyllingen med hvidløkspulver, salt og pepper.", "Gril eller stek kyllingen 6-7 min pr. side.", "Damp broccoli 4 minutter.", "Server over kokte brun ris med litt olivenolje."],
      tip: "Forbered 4-5 bokse om søndagern til hele treningsugen.",
    },
    sv: {
      name: "Kyckling & ris meal prep-boks",
      prepTime: "25 min",
      ingredients: ["200g kycklingebryst", "150g brunt ris (kokt)", "100g broccoli", "1 msk olivolja", "Salt, peppar, hvidlökspulvär"],
      steps: ["Krydda kycklingen med hvidlökspulvär, salt och peppar.", "Gril ellär stek kycklingen 6-7 min pr. side.", "Ånga broccoli i 4 minutär.", "Servera över kokte brunt ris med lite olivolja."],
  ...
  },
  {
    ...
    sv: {
      ...
      prepTime: "30 min",
      ingredients: ["180g laxfiléé", "1 medelstor sötpotatis", "100g sparris", "1 msk olivolja", "Citronsaft", "Dill"],
      steps: ["Förvärm ugnen till 200°C.", "Skär sötpotatis i tärningar, vänd i olivolja, rosta i 20 min.", "Krydda laxen med citron, dill och salt. baka i 12-15 min.", "Ånga sparris 3-4 min. servera tillsammans."],
      tip: "Lax ger omega-3 fettsyror, som är avgörande for ledåterhämtning och inflammationskontrol.",
    },
  },
  {
    id: "r4",
  ...
  },
  {
    ...
    sv: {
      ...
      tip: "Ät 60-90 minutär före träning for optimal energi utan tyngde.",
    },
  },
  {
    id: "r6",
    ...
    sv: {
      ...
      steps: ["Tillsätt alle ingrediensär i en mixär.", "Mixa till det är glat (30 sekundär).", "Drik innan for 30 minutär eftär träning."],
  ...
  },
  {
    ...
    sv: {
      ...
      prepTime: "20 min",
      ingredients: ["180g oksemørbrad (skuret i tynde strimlär)", "100g broccoli", "1 paprika", "100g sockerertär", "2 msk sojasås", "1 msk sesamolja", "1 fed hvidlök", "Kokte ris ellär nudlär"],
      steps: ["Värm sesamolja i en wok ellär stor panna.", "Stek nötköttsstrimlär på hög värme 2-3 min. sätt till side.", "Tillsätt grönsakär och hvidlök, stek 3-4 min.", "Tillsätt nötköttet igen, häll sojasås över, vend tillsammans.", "Servera över ris ellär nudlär."],
      tip: "Nötkött ger jern och B12 — essentielt for ilttransport undär højintens träning.",
    },
  },
  {
    id: "r11",
    ...
    sv: {
      ...
      ingredients: ["80g havregryn", "200ml mjölk", "1 scoop proteinpulvär", "1 msk chiafrön", "100g blandasde bär", "1 tsk honung"],
      steps: ["Blanda havregryn, mjölk, proteinpulvär och chiafrön i et glas.", "Rör gott, lägg låg på och still i kylskåpet natten över.", "Om morgonen, toppaa med bär och honung.", "Ät koldt ellär värm i mikrobølgeugn 2 min."],
      tip: "Forbered 3-4 glas søndag kväll till ubesværede morgonmåltidär i hverdagarn.",
    },
  },
  {
    id: "r12",
  ...
  },
  {
    ...
    no: {
      ...
      tip: "Hurtigt fordøjeakkurat karbohydrater fra frugt gier hurtig energi uten mavebesvær.",
    },
    sv: {
      name: "Energi-smoothie före träning",
      prepTime: "5 min",
      ingredients: ["1 banan", "150g mangobitar", "200ml appelsinjuice", "1 msk havregryn", "1 tsk honung"],
      steps: ["Tillsätt alle ingrediensär i en mixär.", "Mixa till det är glat.", "Drik 45-60 minutär före träning."],
  ...
  },
  {
    ...
    sv: {
      ...
      prepTime: "30 min",
      ingredients: ["200g kycklingebryst", "1 gulerod", "1 bladselleri", "100g ägggenudlär", "500ml kycklingebouillon", "Hvidlök, salt, peppar, persilja"],
  ...
  },
  {
    ...
    sv: {
      ...
      steps: ["Stek kyckling i en panna med teriyakisauce, 5-6 min pr. side.", "Skär kycklingen i strimlär.", "Byg skålarn: ris i bunden, kyckling, edamame, revet gulerod.", "Häll resten av saucen över, toppaa med sesamfrön."],
  ...
  },
  {
    ...
    no: {
      ...
      tip: "En lunsj på treningsdager, der smaker som en dessert men gier energi som et præstationsmåltid.",
    },
    sv: {
      name: "Protein-pandekagär",
      prepTime: "15 min",
      ingredients: ["1 banan", "2 ägg", "30g havregryn", "1 scoop proteinpulvär", "1 tsk bakaepulvär", "Bär till toppaing"],
      steps: ["Mixa banan, ägg, havregryn, proteinpulvär och bakaepulvär.", "Värm en non-stick panna på medium värme.", "Häll små cirklär, stek 2 min pr. side.", "Stak pandekagerne och toppaa med frisked bär."],
  ...
  },
  {
    ...
    sv: {
      ...
      prepTime: "25 min",
      ingredients: ["200g røde linsär", "1 burk kokosmjölk (light)", "200g hakkede tomatär", "1 lök", "2 fed hvidlök", "1 msk karrypulvär", "100g spenat", "Kokte ris"],
      steps: ["Svits hakket lök och hvidlök i olivolja.", "Tillsätt karrypulvär, rör i 1 min.", "Tillsätt linsär, tomatär och kokosmjölk. Lad simre 15-18 min.", "Rör spenat i till det faldär tillsammans.", "Servera över ris."],
  ...
  },
  {
    ...
    sv: {
      ...
      prepTime: "2 min",
      ingredients: ["400ml sødmjölk", "2 msk kakaopulvär", "1 msk honung", "Et strö salt"],
      steps: ["Värm mjölken lätt (ellär använd kold).", "Vispa kakaopulvär, honung och salt i.", "Drik innan for 30 minutär eftär träning."],
  ...
  // ─── r21–r40: 20 additional athlete recipes ───
  {
    ...
    sv: {
      name: "Overnight protein-havregryn",
      prepTime: "5 min (+ natten över)",
      ingredients: ["80g havregryn", "1 scoop vanilje proteinpulvär", "200ml mandelmjölk", "1 msk chiafrön", "1 msk mandelbuttär", "Kanel"],
      steps: ["Blanda havregryn, proteinpulvär, mjölk och chiafrön i et glas.", "Rör mandelbuttär i.", "Still i kylskåpet natten över.", "Toppaa med kanel och ät koldt ellär värmt."],
      tip: "Proteinpulvär i overnight oats gör en simpel frukost till et 28g protein-återhämtningsmåltid.",
    },
  },
  {
    id: "r22",
  ...
  },
  {
    ...
    sv: {
      name: "Banan protein-muffins",
      prepTime: "25 min",
      ingredients: ["2 mogna bananär", "2 ägg", "60g havremel", "1 scoop proteinpulvär", "1 tsk bakaepulvär", "1 msk honung"],
      steps: ["Förvärm ugnen till 180°C.", "Mosa bananerna, vispa ägggene i.", "Fold havremel, proteinpulvär och bakaepulvär i.", "Häll i muffinform (ger 6 stk). baka 18-20 min."],
  ...
  },
  {
    ...
    sv: {
      ...
      prepTime: "20 min",
      ingredients: ["200g hakket kalkon", "150g kokt quinoa", "100g sorte bönor", "1/2 avokado", "50g majs", "Lime, spidskommen, chilipulvär"],
      steps: ["Brun kalkonen med spidskommen och chilipulvär.", "Byg skålarn: quinoa i bunden, kalkon, sorte bönor, majs.", "Skär avokado i skivor ovanpå.", "Pressa lime över det hele."],
  ...
  },
  {
    ...
    no: {
      ...
      tip: "En middelhavs-klassiker fyllt med omega-3, protein og sunne fedtsyrer til vedvarende treningsenergi.",
    },
    sv: {
  ...
  },
  {
    ...
    no: {
      ...
      tip: "Et plantebaseret kraftcenter — sorte bønner og søtpotet gier fiber, jern og sakte forbrændende karbohydrater.",
    },
    sv: {
  ...
  },
  {
    ...
    sv: {
      ...
      prepTime: "15 min",
      ingredients: ["150g grillaet kycklingebryst", "120g fuldkorns fusilli (kokt)", "2 msk pesto", "50g cherrytomatär", "30g mozzarella", "Frisk basilika"],
      ...
      tip: "Fantastisk kold ellär värm — perfekt till meal prep-bokse mellan dobbelte träningspas.",
    },
  },
  {
    id: "r29",
    ...
    sv: {
      ...
      prepTime: "25 min",
      ingredients: ["180g laxfiléé", "1 squash", "1 paprika", "100g cherrytomatär", "2 msk olivolja", "Herbes de Provence"],
  ...
  },
  {
    ...
    sv: {
      name: "Chicken tikka med basmatiris",
      prepTime: "30 min",
      ingredients: ["200g kycklingebryst", "100g grekisk yoghurt", "2 msk tikka-paste", "150g basmatiris", "Citronsaft", "Frisk koriandär"],
      steps: ["Marinär kyckling i yoghurt och tikka-paste i 10 min.", "Gril ellär stek kycklingen 6-7 min pr. side.", "Koch basmatiris.", "Skär kycklingen i skivor, servera över ris med citron och koriandär."],
  ...
  },
  {
    ...
    no: {
      ...
      tip: "Mager bolognese leverer jern, zink og B-vitaminer, det er afgørende for åletisk præstation.",
    },
    sv: {
  ...
  },
  {
    ...
    sv: {
      ...
      prepTime: "10 min",
      ingredients: ["100g havregryn", "60g blandasde nøddär (knuste)", "40g torkade tranebär", "2 msk honung", "2 msk kokosolja (smeltet)", "1 msk kakaopulvär"],
  ...
  },
  {
    ...
    sv: {
      ...
      prepTime: "5 min",
      ingredients: ["1 scoop proteinpulvär", "100g frysta blandasde bär", "1 banan", "100ml mjölk", "30g granola", "1 msk kokosflingor"],
      steps: ["Mixa proteinpulvär, frysta bär, banan och mjölk till det är tjockt.", "Häll i en skål.", "Toppaa med granola och kokosflingor.", "Ät med en sked — det ska vara tjockt, inte flytande."],
