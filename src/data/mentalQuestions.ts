...
export const adultQuestions: MentalQuestion[] = [
  ...
  },
  {
    ...
    category: "focusConcentration",
    text: {
      en: "When I train alone without a coach present, my focus is...",
      da: "Når jeg træner alene uden en træner til stede, er mit fokus...",
      sv: "När jag tränar ensam utan en tränare närvarande är mitt fokus...",
      de: "Wenn ich allein ohne Trainer trainiere, ist mein Fokus...",
      ar: "عندما أتدرب وحدي دون وجود مدرب، تركيزي..."
    },
    variants: [
      { en: "No coach watching, just you and the session. Your focus is...", da: "Ingen træner der kigger, kun dig og træningen. Dit fokus er...", sv: "Ingen tränare som tittar, bara du och passet. Ditt fokus är...", de: "Kein Trainer schaut zu, nur du und die Einheit. Dein Fokus ist...", ar: "لا مدرب يراقب، أنت والتمرين فقط. تركيزك..." },
      { en: "A solo session on your own program. How long does your focus hold?", da: "En solotræning på dit eget program. Hvor længe holder dit fokus?", sv: "Ett soloträningspass på ditt eget program. Hur länge håller fokus?", de: "Eine Solo-Einheit nach deinem eigenen Programm. Wie lange hält dein Fokus?", ar: "تمرين فردي وفق برنامجك. كم يصمد تركيزك؟" },
    ],
    options: [
      { value: 1, label: { en: "Gone after a few minutes", da: "Væk efter få minutter", sv: "Borta efter några minuter", de: "Nach wenigen Minuten weg", ar: "يختفي بعد دقائق قليلة" } },
      { value: 2, label: { en: "Drifts constantly, I cut the session short", da: "Driver hele tiden, jeg afkorter træningen", sv: "Driver hela tiden, jag kortar ner passet", de: "Schweift ständig ab, ich breche die Einheit ab", ar: "يشرد باستمرار، وأختصر التمرين" } },
      { value: 3, label: { en: "Okay for the first half, then it fades", da: "Okay i første halvdel, så falder det", sv: "Okej första halvan, sedan avtar det", de: "In der ersten Hälfte okay, dann lässt es nach", ar: "جيد في النصف الأول، ثم يتلاشى" } },
      { value: 4, label: { en: "Solid — I get through my plan as intended", da: "Solidt — jeg gennemfører min plan som tænkt", sv: "Stabilt — jag genomför min plan som tänkt", de: "Solide — ich ziehe meinen Plan wie geplant durch", ar: "ثابت — أنفذ خطتي كما هي" } },
      { value: 5, label: { en: "The same as at team training", da: "Det samme som til holdtræning", sv: "Detsamma som på lagträning", de: "Genauso wie im Mannschaftstraining", ar: "نفسه كما في تدريب الفريق" } },
    ],
  },
  // Competition Anxiety
  {
  ...
  },
  {
    ...
    category: "competitionAnxiety",
    text: {
      en: "In the week before an important competition, thoughts about it take up...",
      da: "I ugen op til en vigtig konkurrence fylder tankerne om den...",
      sv: "Veckan före en viktig tävling tar tankarna på den upp...",
      de: "In der Woche vor einem wichtigen Wettkampf nehmen die Gedanken daran...",
      ar: "في الأسبوع الذي يسبق منافسة مهمة، تشغل الأفكار عنها..."
    },
    variants: [
      { en: "Seven days out from a big competition. How much headspace does it take?", da: "Syv dage før et stort stævne. Hvor meget plads tager det i hovedet?", sv: "Sju dagar före en stor tävling. Hur mycket plats tar det i huvudet?", de: "Sieben Tage vor einem großen Wettkampf. Wie viel Kopf nimmt es ein?", ar: "سبعة أيام قبل منافسة كبيرة. كم تشغل من تفكيرك؟" },
    ],
    options: [
      { value: 1, label: { en: "So much that school, sleep and mood suffer", da: "Så meget at det går ud over skole, søvn og humør", sv: "Så mycket att skola, sömn och humör blir lidande", de: "So viel, dass Schule, Schlaf und Stimmung leiden", ar: "كثيرًا لدرجة تؤثر على الدراسة والنوم والمزاج" } },
      { value: 2, label: { en: "A lot — it's hard to think about anything else", da: "Meget — det er svært at tænke på andet", sv: "Mycket — svårt att tänka på något annat", de: "Viel — es fällt schwer an anderes zu denken", ar: "كثيرًا — يصعب التفكير في شيء آخر" } },
      { value: 3, label: { en: "Quite a bit, especially in the evenings", da: "En del, især om aftenen", sv: "En hel del, särskilt på kvällarna", de: "Ziemlich viel, besonders abends", ar: "قدرًا لا بأس به، خاصة في المساء" } },
      { value: 4, label: { en: "Some — mostly when I prepare for it", da: "Noget — mest når jeg forbereder mig", sv: "En del — mest när jag förbereder mig", de: "Etwas — vor allem bei der Vorbereitung", ar: "بعض الشيء — غالبًا عند التحضير" } },
      { value: 5, label: { en: "A fitting amount — I think about it without it filling everything", da: "Passende — jeg tænker på den uden at den fylder alt", sv: "Lagom — jag tänker på den utan att den tar över allt", de: "Angemessen — ich denke daran, ohne dass es alles einnimmt", ar: "بقدر مناسب — أفكر فيها دون أن تستحوذ على كل شيء" } },
    ],
  },
  // Motivation
  {
  ...
  },
  {
    ...
    category: "confidence",
    text: {
      en: "When I have to perform in front of people I want to impress, my belief in myself is...",
      da: "Når jeg skal præstere foran nogen, jeg gerne vil imponere, er min tro på mig selv...",
      sv: "När jag ska prestera inför personer jag vill imponera på är min tro på mig själv...",
      de: "Wenn ich vor Menschen auftreten muss, die ich beeindrucken möchte, ist mein Selbstvertrauen...",
      ar: "عندما يجب أن أؤدي أمام أشخاص أريد إبهارهم، تكون ثقتي بنفسي..."
    },
    variants: [
      { en: "The national coach, your family, a selection panel — they're watching. Your self-belief is...", da: "Landstræneren, din familie, et udtagelsesudvalg — de kigger. Din tro på dig selv er...", sv: "Landslagstränaren, din familj, en uttagningsgrupp — de tittar. Din tro på dig själv är...", de: "Der Nationaltrainer, deine Familie, ein Auswahlgremium — sie schauen zu. Dein Selbstvertrauen ist...", ar: "المدرب الوطني، عائلتك، لجنة اختيار — إنهم يشاهدون. ثقتك بنفسك..." },
    ],
    options: [
      { value: 1, label: { en: "Much smaller than normal", da: "Meget mindre end normalt", sv: "Mycket mindre än normalt", de: "Viel geringer als sonst", ar: "أقل بكثير من المعتاد" } },
      { value: 2, label: { en: "Smaller — I play it safe", da: "Mindre — jeg spiller sikkert", sv: "Mindre — jag spelar säkert", de: "Geringer — ich gehe auf Nummer sicher", ar: "أقل — ألعب بحذر" } },
      { value: 3, label: { en: "A bit shaky at the start, then it settles", da: "Lidt rystet i starten, så falder det på plads", sv: "Lite skakig i början, sedan lägger det sig", de: "Anfangs etwas wackelig, dann legt es sich", ar: "مهزوزة في البداية ثم تستقر" } },
      { value: 4, label: { en: "Steady — I stick to what I've trained", da: "Stabil — jeg holder fast i det, jeg har trænet", sv: "Stabil — jag håller fast vid det jag tränat", de: "Stabil — ich bleibe bei dem, was ich trainiert habe", ar: "ثابتة — ألتزم بما تدربت عليه" } },
      { value: 5, label: { en: "The same as always", da: "Den samme som altid", sv: "Densamma som alltid", de: "Genau wie immer", ar: "كما هي دائمًا" } },
    ],
  },
  // Mental Resilience
  {
    id: "mr1",
    category: "mentalResilience",
    text: {
  ...
  {
    id: "mx1",
    category: "mentalFlexibility",
    text: {
      en: "When my plan in a match isn't working, I...",
      da: "Når min plan i en kamp ikke virker, så...",
      sv: "När min plan i en match inte fungerar, så...",
      de: "Wenn mein Plan in einem Kampf nicht funktioniert, dann...",
      ar: "عندما لا تنجح خطتي في المباراة، أنا..."
    },
    variants: [
      { en: "Round one is over and the game plan clearly isn't landing. You...", da: "Første omgang er slut, og kampplanen virker tydeligvis ikke. Du...", sv: "Första ronden är slut och matchplanen fungerar tydligt inte. Du...", de: "Runde eins ist vorbei und der Matchplan geht klar nicht auf. Du...", ar: "انتهت الجولة الأولى وخطتك لا تنجح بوضوح. أنت..." },
    ],
    options: [
      { value: 1, label: { en: "Stick to the same thing no matter what", da: "Holder jeg fast i det samme uanset hvad", sv: "Håller jag fast vid samma sak oavsett", de: "Halte ich an dem Gleichen fest, egal was", ar: "أتمسك بالشيء نفسه مهما حدث" } },
      { value: 2, label: { en: "Keep going and only change when it's too late", da: "Fortsætter jeg og skifter først når det er for sent", sv: "Fortsätter jag och byter först när det är för sent", de: "Mache ich weiter und wechsle erst zu spät", ar: "أستمر ولا أغيّر إلا بعد فوات الأوان" } },
      { value: 3, label: { en: "Sense that something is wrong but hesitate", da: "Mærker jeg at noget er galt, men tøver", sv: "Känner jag att något är fel men tvekar", de: "Merke ich, dass etwas nicht stimmt, zögere aber", ar: "أشعر أن هناك خطأ لكنني أتردد" } },
      { value: 4, label: { en: "Change after a break or a word from my coach", da: "Skifter jeg efter en pause eller et ord fra træneren", sv: "Byter jag efter en paus eller ett ord från tränaren", de: "Wechsle ich nach einer Pause oder einem Wort vom Trainer", ar: "أغيّر بعد استراحة أو كلمة من مدربي" } },
      { value: 5, label: { en: "Switch quickly to something that fits better", da: "Skifter jeg hurtigt til noget der passer bedre", sv: "Byter jag snabbt till något som passar bättre", de: "Wechsle ich schnell zu etwas Passenderem", ar: "أنتقل بسرعة إلى ما يناسب أكثر" } },
    ],
  },
  {
    id: "mx2",
    category: "mentalFlexibility",
    text: {
      en: "When the coach changes the drill halfway through training, I...",
      da: "Når træneren ændrer opgaven midt i træningen, så...",
      sv: "När tränaren ändrar övningen mitt i träningen, så...",
      de: "Wenn der Trainer die Übung mitten im Training ändert, dann...",
      ar: "عندما يغيّر المدرب التمرين في منتصف الحصة، أنا..."
    },
    variants: [
      { en: "You're deep in a drill and the coach calls a completely different one. You...", da: "Du er dybt inde i en øvelse, og træneren kalder en helt anden. Du...", sv: "Du är djupt inne i en övning och tränaren ropar ut en helt annan. Du...", de: "Du bist mitten in einer Übung und der Trainer ruft eine ganz andere aus. Du...", ar: "أنت منغمس في تمرين والمدرب يطلب تمرينًا مختلفًا تمامًا. أنت..." },
    ],
    options: [
      { value: 1, label: { en: "Get irritated and struggle to switch", da: "Bliver jeg irriteret og har svært ved at omstille mig", sv: "Blir jag irriterad och har svårt att ställa om", de: "Werde ich gereizt und tue mich schwer umzustellen", ar: "أنزعج وأجد صعوبة في التأقلم" } },
      { value: 2, label: { en: "Follow along, but my head stays in the old drill", da: "Følger jeg med, men mit hoved er stadig i den gamle opgave", sv: "Följer jag med, men huvudet är kvar i den gamla övningen", de: "Mache ich mit, aber mein Kopf bleibt bei der alten Übung", ar: "أتابع، لكن ذهني يبقى في التمرين السابق" } },
      { value: 3, label: { en: "Need a few minutes to get into it", da: "Skal jeg bruge et par minutter på at komme ind i det", sv: "Behöver jag några minuter för att komma in i det", de: "Brauche ich ein paar Minuten, um reinzukommen", ar: "أحتاج بضع دقائق للدخول فيه" } },
      { value: 4, label: { en: "Adjust without much trouble", da: "Omstiller jeg mig uden de store problemer", sv: "Ställer jag om utan större problem", de: "Stelle ich mich ohne große Probleme um", ar: "أتأقلم دون مشكلة تُذكر" } },
      { value: 5, label: { en: "Switch straight away", da: "Omstiller jeg mig med det samme", sv: "Ställer jag om direkt", de: "Stelle ich mich sofort um", ar: "أتأقلم على الفور" } },
    ],
  },
  {
    id: "mx3",
    category: "mentalFlexibility",
    text: {
      en: "When I face an opponent with a completely different style than expected, I...",
      da: "Når jeg møder en modstander med en helt anden stil end forventet, så...",
      sv: "När jag möter en motståndare med en helt annan stil än väntat, så...",
      de: "Wenn ich auf einen Gegner mit einem ganz anderen Stil als erwartet treffe, dann...",
      ar: "عندما أواجه خصمًا بأسلوب مختلف تمامًا عن المتوقع، أنا..."
    },
    variants: [
      { en: "You prepared for a counter-fighter and meet a pressure fighter. You...", da: "Du har forberedt dig på en kontrafighter og møder en presfighter. Du...", sv: "Du har förberett dig på en kontringsfighter och möter en pressfighter. Du...", de: "Du hast dich auf einen Konterkämpfer vorbereitet und triffst auf einen Druckkämpfer. Du...", ar: "استعددت لمقاتل مرتد فواجهت مقاتلًا ضاغطًا. أنت..." },
    ],
    options: [
      { value: 1, label: { en: "Get locked into my preparation", da: "Bliver jeg låst fast i min forberedelse", sv: "Låser jag fast mig i min förberedelse", de: "Klammere ich mich an meine Vorbereitung", ar: "أظل حبيس تحضيري" } },
      { value: 2, label: { en: "Feel thrown and lose my rhythm", da: "Bliver jeg slået ud af kurs og mister min rytme", sv: "Kastas jag ur och tappar min rytm", de: "Werde ich aus dem Konzept gebracht und verliere den Rhythmus", ar: "أفقد توازني وإيقاعي" } },
      { value: 3, label: { en: "Adjust, but only after losing ground", da: "Justerer jeg, men først efter at have tabt terræn", sv: "Anpassar jag mig, men först efter att ha tappat mark", de: "Passe ich mich an, aber erst nach Rückstand", ar: "أتكيّف، لكن بعد أن أخسر أرضًا" } },
      { value: 4, label: { en: "Read the new style and change plan between rounds", da: "Læser jeg den nye stil og ændrer plan mellem omgangene", sv: "Läser jag den nya stilen och ändrar plan mellan ronderna", de: "Lese ich den neuen Stil und ändere den Plan zwischen den Runden", ar: "أقرأ الأسلوب الجديد وأغيّر الخطة بين الجولات" } },
      { value: 5, label: { en: "Adjust my tactics as the match unfolds", da: "Justerer jeg taktikken undervejs", sv: "Justerar jag taktiken under matchens gång", de: "Passe ich meine Taktik im Verlauf an", ar: "أعدّل تكتيكي أثناء المباراة" } },
    ],
  },
  {
    id: "mx4",
    category: "mentalFlexibility",
    text: {
      en: "When something unexpected happens on competition day — a delay, a changed bracket, a cancelled warm-up — I...",
      da: "Når noget uventet sker på stævnedagen — forsinkelse, ændret pulje, aflyst opvarmning — så...",
      sv: "När något oväntat händer på tävlingsdagen — en försening, ändrad pool, inställd uppvärmning — så...",
      de: "Wenn am Wettkampftag etwas Unerwartetes passiert — Verzögerung, geänderter Pool, abgesagtes Aufwärmen — dann...",
      ar: "عندما يحدث شيء غير متوقع في يوم البطولة — تأخير، تغيير المجموعة، إلغاء الإحماء — أنا..."
    },
    variants: [
      { en: "The schedule slips two hours and your warm-up mat is gone. You...", da: "Programmet skrider to timer, og din opvarmningsmåtte er væk. Du...", sv: "Schemat glider två timmar och din uppvärmningsmatta är borta. Du...", de: "Der Zeitplan verschiebt sich um zwei Stunden und deine Aufwärmmatte ist weg. Du...", ar: "يتأخر الجدول ساعتين وتختفي سجادة الإحماء. أنت..." },
    ],
    options: [
      { value: 1, label: { en: "It throws me completely off track", da: "Kaster det mig helt af sporet", sv: "Kastar det mig helt ur banan", de: "Wirft es mich komplett aus der Bahn", ar: "يخرجني عن مساري تمامًا" } },
      { value: 2, label: { en: "I get stressed and carry it into the match", da: "Bliver jeg stresset og tager det med ind i kampen", sv: "Blir jag stressad och tar med det in i matchen", de: "Werde ich gestresst und nehme es mit in den Kampf", ar: "أتوتر وأحمل ذلك إلى المباراة" } },
      { value: 3, label: { en: "I'm annoyed but get myself going eventually", da: "Er jeg irriteret, men kommer i gang til sidst", sv: "Är jag irriterad men kommer igång till slut", de: "Bin ich genervt, komme aber schließlich in Gang", ar: "أنزعج لكنني أستعيد نشاطي في النهاية" } },
      { value: 4, label: { en: "I accept it and adjust my preparation", da: "Accepterer jeg det og justerer min forberedelse", sv: "Accepterar jag det och justerar min förberedelse", de: "Akzeptiere ich es und passe meine Vorbereitung an", ar: "أتقبله وأعدّل تحضيري" } },
      { value: 5, label: { en: "I find a new way to get myself ready", da: "Finder jeg en ny måde at gøre mig klar på", sv: "Hittar jag ett nytt sätt att göra mig redo", de: "Finde ich einen neuen Weg, mich bereit zu machen", ar: "أجد طريقة جديدة لأجهّز نفسي" } },
    ],
  },
];

/** Junior questions (under 15) — simpler language, sport-neutral */
export const juniorQuestions: MentalQuestion[] = [
  ...
  },
  {
    ...
    category: "focusConcentration",
    text: {
      en: "When I train at home without a coach, my focus is...",
      da: "Når jeg træner derhjemme uden en træner, er mit fokus...",
      sv: "När jag tränar hemma utan en tränare är mitt fokus...",
      de: "Wenn ich zu Hause ohne Trainer trainiere, ist mein Fokus...",
      ar: "عندما أتدرب في البيت دون مدرب، تركيزي..."
    },
    options: [
      { value: 1, label: { en: "Gone after a few minutes", da: "Væk efter få minutter", sv: "Borta efter några minuter", de: "Nach ein paar Minuten weg", ar: "يختفي بعد دقائق قليلة" } },
      { value: 2, label: { en: "I get distracted and stop quickly", da: "Jeg bliver distraheret og stopper hurtigt", sv: "Jag blir distraherad och slutar snabbt", de: "Ich werde abgelenkt und höre schnell auf", ar: "أتشتت وأتوقف بسرعة" } },
      { value: 3, label: { en: "Okay for a little while", da: "Okay i et stykke tid", sv: "Okej en stund", de: "Eine Weile okay", ar: "جيد لبعض الوقت" } },
      { value: 4, label: { en: "Pretty good — I finish what I planned", da: "Ret godt — jeg gør det færdigt, jeg havde planlagt", sv: "Ganska bra — jag gör klart det jag planerat", de: "Ziemlich gut — ich mache fertig was ich geplant habe", ar: "جيد جدًا — أُنهي ما خططت له" } },
      { value: 5, label: { en: "Just as good as at training with my club", da: "Lige så godt som til træning i klubben", sv: "Lika bra som på träning i klubben", de: "Genauso gut wie beim Training im Verein", ar: "بنفس جودة التدريب في النادي" } },
    ],
  },
  // Competition Anxiety
  {
  ...
  },
  {
    ...
    category: "competitionAnxiety",
    text: {
      en: "The week before a competition, I think about it...",
      da: "Ugen før et stævne tænker jeg på det...",
      sv: "Veckan före en tävling tänker jag på den...",
      de: "In der Woche vor einem Wettkampf denke ich daran...",
      ar: "في الأسبوع قبل البطولة أفكر فيها..."
    },
    options: [
      { value: 1, label: { en: "All the time — it's hard to sleep and be at school", da: "Hele tiden — det er svært at sove og være i skole", sv: "Hela tiden — svårt att sova och vara i skolan", de: "Die ganze Zeit — Schlafen und Schule fallen schwer", ar: "طوال الوقت — يصعب النوم والدراسة" } },
      { value: 2, label: { en: "Very often, and it makes me worried", da: "Meget ofte, og det gør mig bekymret", sv: "Väldigt ofta, och det gör mig orolig", de: "Sehr oft, und es macht mich unruhig", ar: "كثيرًا جدًا، ويجعلني قلقًا" } },
      { value: 3, label: { en: "Quite often, mostly at bedtime", da: "Ret ofte, mest når jeg skal sove", sv: "Ganska ofta, mest vid läggdags", de: "Ziemlich oft, meistens vorm Schlafen", ar: "كثيرًا، غالبًا وقت النوم" } },
      { value: 4, label: { en: "A little, and then I think about other things", da: "Lidt, og så tænker jeg på andre ting", sv: "Lite, och sedan tänker jag på annat", de: "Ein wenig, dann denke ich an anderes", ar: "قليلًا، ثم أفكر في أشياء أخرى" } },
      { value: 5, label: { en: "Just the right amount — I look forward to it and live my normal life", da: "Tilpas — jeg glæder mig og lever mit almindelige liv", sv: "Lagom — jag ser fram emot den och lever som vanligt", de: "Gerade richtig — ich freue mich und lebe normal weiter", ar: "بقدر مناسب — أتطلع إليها وأعيش حياتي بشكل طبيعي" } },
    ],
  },
  // Motivation
  {
    ...
    category: "motivation",
    text: {
      en: "How much do I want to go to training?",
      da: "Hvor meget har jeg lyst til at tage til træning?",
      sv: "Hur mycket vill jag gå på träning?",
      de: "Wie sehr möchte ich zum Training gehen?",
      ar: "كم أرغب في الذهاب إلى التدريب؟"
    },
    options: [
  ...
  },
  {
    ...
    category: "motivation",
    text: {
      en: "Do I have goals in my sport?",
      da: "Har jeg mål i min sport?",
      sv: "Har jag mål i min sport?",
      de: "Habe ich Ziele in meinem Sport?",
      ar: "هل لدي أهداف في رياضتي؟"
    },
    options: [
  ...
  // Confidence
  {
    ...
    category: "confidence",
    text: {
      en: "How much do I believe in myself in my sport?",
      da: "Hvor meget tror jeg på mig selv i min sport?",
      sv: "Hur mycket tror jag på mig själv i min sport?",
      de: "Wie sehr glaube ich an mich selbst in meinem Sport?",
      ar: "كم أؤمن بنفسي في رياضتي؟"
    },
    options: [
  ...
  },
  {
    ...
    category: "confidence",
    text: {
      en: "When people I know are watching me train or compete, I believe in myself...",
      da: "Når nogen jeg kender ser på, mens jeg træner eller kæmper, tror jeg på mig selv...",
      sv: "När folk jag känner tittar när jag tränar eller tävlar tror jag på mig själv...",
      de: "Wenn Leute, die ich kenne, mir beim Training oder Wettkampf zusehen, glaube ich an mich...",
      ar: "عندما يشاهدني أشخاص أعرفهم أثناء التدريب أو المنافسة، أؤمن بنفسي..."
    },
    options: [
      { value: 1, label: { en: "Much less than usual", da: "Meget mindre end normalt", sv: "Mycket mindre än vanligt", de: "Viel weniger als sonst", ar: "أقل بكثير من المعتاد" } },
      { value: 2, label: { en: "Less — I get shy and hold back", da: "Mindre — jeg bliver genert og holder igen", sv: "Mindre — jag blir blyg och håller igen", de: "Weniger — ich werde schüchtern und halte mich zurück", ar: "أقل — أخجل وأتراجع" } },
      { value: 3, label: { en: "A bit nervous first, then it's okay", da: "Lidt nervøs først, så er det okay", sv: "Lite nervös först, sedan är det okej", de: "Erst etwas nervös, dann geht es", ar: "متوتر قليلًا في البداية ثم أرتاح" } },
      { value: 4, label: { en: "Fine — I just do what I always do", da: "Fint — jeg gør bare det, jeg plejer", sv: "Bra — jag gör bara som jag brukar", de: "Gut — ich mache einfach wie immer", ar: "بخير — أفعل ما أفعله دائمًا" } },
      { value: 5, label: { en: "Just as much as always", da: "Lige så meget som altid", sv: "Lika mycket som alltid", de: "Genauso wie immer", ar: "بنفس القدر دائمًا" } },
    ],
  },
  // Mental Resilience
  {
  ...
  // Mental Flexibility
  {
    ...
    category: "mentalFlexibility",
    text: {
      en: "When what I have practised doesn't work in the match, I...",
      da: "Når det jeg har øvet ikke virker i kampen, så...",
      sv: "När det jag har övat inte fungerar i matchen, så...",
      de: "Wenn das, was ich geübt habe, im Kampf nicht klappt, dann...",
      ar: "عندما لا ينجح ما تدربت عليه في المباراة، أنا..."
    },
    options: [
      { value: 1, label: { en: "Keep doing the same thing anyway", da: "Bliver jeg ved med det samme alligevel", sv: "Fortsätter jag med samma sak ändå", de: "Mache ich trotzdem das Gleiche weiter", ar: "أستمر بنفس الشيء على أي حال" } },
      { value: 2, label: { en: "Get annoyed and stop trying", da: "Bliver jeg irriteret og holder op med at prøve", sv: "Blir jag irriterad och slutar försöka", de: "Werde ich genervt und höre auf zu versuchen", ar: "أنزعج وأتوقف عن المحاولة" } },
      { value: 3, label: { en: "Notice it but don't know what to do", da: "Opdager jeg det, men ved ikke hvad jeg skal gøre", sv: "Märker jag det men vet inte vad jag ska göra", de: "Merke ich es, weiß aber nicht was tun", ar: "ألاحظ ذلك لكن لا أعرف ماذا أفعل" } },
      { value: 4, label: { en: "Try something else when my coach tells me to", da: "Prøver jeg noget andet, når træneren siger det", sv: "Provar jag något annat när tränaren säger till", de: "Probiere ich etwas anderes, wenn mein Trainer es sagt", ar: "أجرب شيئًا آخر عندما يخبرني مدربي" } },
      { value: 5, label: { en: "Quickly try something that works better", da: "Prøver jeg hurtigt noget der virker bedre", sv: "Provar jag snabbt något som fungerar bättre", de: "Probiere ich schnell etwas, das besser klappt", ar: "أجرب بسرعة شيئًا أفضل" } },
    ],
  },
  {
    id: "mx2",
    category: "mentalFlexibility",
    text: {
      en: "When the coach suddenly says we're doing something else, I...",
      da: "Når træneren pludselig siger, at vi skal lave noget andet, så...",
      sv: "När tränaren plötsligt säger att vi ska göra något annat, så...",
      de: "Wenn der Trainer plötzlich sagt, dass wir etwas anderes machen, dann...",
      ar: "عندما يقول المدرب فجأة إننا سنفعل شيئًا آخر، أنا..."
    },
    options: [
      { value: 1, label: { en: "Get annoyed and don't want to", da: "Bliver jeg sur og har ikke lyst", sv: "Blir jag sur och vill inte", de: "Werde ich sauer und will nicht", ar: "أنزعج ولا أرغب" } },
      { value: 2, label: { en: "Join in but sulk a bit", da: "Er jeg med, men er lidt sur over det", sv: "Är jag med men surar lite", de: "Mache ich mit, schmolle aber ein bisschen", ar: "أشارك لكنني منزعج قليلًا" } },
      { value: 3, label: { en: "Need a little while to get going", da: "Skal jeg lige bruge lidt tid på at komme i gang", sv: "Behöver jag lite tid att komma igång", de: "Brauche ich kurz Zeit, um loszulegen", ar: "أحتاج قليلًا من الوقت للبدء" } },
      { value: 4, label: { en: "Join in pretty quickly", da: "Er jeg med ret hurtigt", sv: "Hänger jag med ganska snabbt", de: "Bin ich ziemlich schnell dabei", ar: "أنضم بسرعة إلى حد ما" } },
      { value: 5, label: { en: "Start on the new thing right away", da: "Går jeg i gang med det nye med det samme", sv: "Sätter jag igång med det nya direkt", de: "Fange ich sofort mit dem Neuen an", ar: "أبدأ بالشيء الجديد فورًا" } },
    ],
  },
  {
    id: "mx3",
    category: "mentalFlexibility",
    text: {
      en: "When my opponent does something I didn't expect at all, I...",
      da: "Når min modstander gør noget, jeg slet ikke havde regnet med, så...",
      sv: "När min motståndare gör något jag inte alls väntat mig, så...",
      de: "Wenn mein Gegner etwas macht, womit ich gar nicht gerechnet habe, dann...",
      ar: "عندما يفعل خصمي شيئًا لم أتوقعه إطلاقًا، أنا..."
    },
    options: [
      { value: 1, label: { en: "Freeze and don't know what to do", da: "Fryser jeg og ved ikke hvad jeg skal gøre", sv: "Fryser jag och vet inte vad jag ska göra", de: "Erstarre ich und weiß nicht, was ich tun soll", ar: "أتجمد ولا أعرف ماذا أفعل" } },
      { value: 2, label: { en: "Get scared and just defend", da: "Bliver jeg bange og forsvarer mig bare", sv: "Blir jag rädd och försvarar mig bara", de: "Bekomme ich Angst und verteidige nur", ar: "أخاف وأكتفي بالدفاع" } },
      { value: 3, label: { en: "Keep doing what I planned", da: "Bliver jeg ved med det jeg havde planlagt", sv: "Fortsätter jag med det jag planerat", de: "Mache ich weiter wie geplant", ar: "أستمر بما خططت له" } },
      { value: 4, label: { en: "Try to figure out what works instead", da: "Prøver jeg at finde ud af hvad der virker i stedet", sv: "Försöker jag lista ut vad som fungerar istället", de: "Versuche ich herauszufinden, was stattdessen wirkt", ar: "أحاول اكتشاف ما ينفع بدلًا من ذلك" } },
      { value: 5, label: { en: "Change what I do while the match is going", da: "Ændrer jeg det jeg gør, mens kampen kører", sv: "Ändrar jag vad jag gör medan matchen pågår", de: "Ändere ich mein Vorgehen mitten im Kampf", ar: "أغيّر ما أفعله أثناء المباراة" } },
    ],
  },
  {
    id: "mx4",
    category: "mentalFlexibility",
    text: {
      en: "When something is different than planned at a competition, I...",
      da: "Når noget bliver anderledes end planlagt til et stævne, så...",
      sv: "När något blir annorlunda än planerat på en tävling, så...",
      de: "Wenn bei einem Wettkampf etwas anders läuft als geplant, dann...",
      ar: "عندما يختلف شيء عمّا كان مخططًا في البطولة، أنا..."
    },
    options: [
      { value: 1, label: { en: "Get really upset and can't focus", da: "Bliver jeg rigtig ked af det og kan ikke koncentrere mig", sv: "Blir jag jätteledsen och kan inte fokusera", de: "Bin ich total durcheinander und kann mich nicht konzentrieren", ar: "أنزعج كثيرًا ولا أستطيع التركيز" } },
      { value: 2, label: { en: "Get stressed and take it into my match", da: "Bliver jeg stresset og tager det med ind i min kamp", sv: "Blir jag stressad och tar med det in i min match", de: "Werde ich gestresst und nehme es mit in meinen Kampf", ar: "أتوتر وأحمل ذلك إلى مباراتي" } },
      { value: 3, label: { en: "Get annoyed, but it passes", da: "Bliver jeg irriteret, men det går over", sv: "Blir jag irriterad, men det går över", de: "Ärgere ich mich, aber es geht vorbei", ar: "أنزعج، لكن ذلك يزول" } },
      { value: 4, label: { en: "Say okay and get ready anyway", da: "Siger jeg okay og gør mig klar alligevel", sv: "Säger jag okej och gör mig redo ändå", de: "Sage ich okay und mache mich trotzdem bereit", ar: "أقول لا بأس وأستعد على أي حال" } },
      { value: 5, label: { en: "Find another way to get ready", da: "Finder jeg en anden måde at gøre mig klar på", sv: "Hittar jag ett annat sätt att göra mig redo", de: "Finde ich einen anderen Weg, mich bereit zu machen", ar: "أجد طريقة أخرى لأستعد" } },
    ],
  },
];
