...
import { Dumbbell, Brain, UtensilsCrossed, ClipboardList, ArrowLeft, BookOpen, Zap, ShieldCheck, FileText, Swords, Footprints } from "lucide-react";
...
const libraries: {
  ...
  { id: "running", labelKey: "libRunningLabel", descKey: "libRunningDesc", icon: Footprints, color: "text-sky-500" },
