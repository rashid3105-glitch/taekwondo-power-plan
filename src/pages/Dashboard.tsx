...
export default function Dashboard() {
  ...
  const NAV_ITEMS: { tab: typeof activeTab; icon: typeof Home; labelKey: string; color: string }[] = [
    ...
    // "testing" tab removed from main nav — physical testing is now reached via Library → Physical tests → "Test results"
                        ...
                        <div className="flex items-center gap-1">
                          ...
                          <AlertDialog>
                            <AlertDialogTrigger asChild>
                              <Button variant="ghost" size="icon" className="h-8 w-8 text-destructive hover:text-destructive" aria-label={t("delete")} title={t("delete")}>
