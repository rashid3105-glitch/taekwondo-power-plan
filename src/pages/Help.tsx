...
const TOPICS: Record<TopicKey, Topic> = {
  ...
  helpDiary: { key: "helpDiary", icon: BookHeart, isNew: true },
...
const CHANGELOG: { dateKey: string; entries: string[]; build?: string }[] = [
  { dateKey: "changelog_2026_09_21", entries: ["changelogEntry257"], build: "v1.5.74" },
  { dateKey: "changelog_2026_09_17", entries: ["changelogEntry256", "changelogEntry255", "changelogEntry254", "changelogEntry253"], build: "v1.5.73" },
  { dateKey: "changelog_2026_09_15", entries: ["changelogEntry252", "changelogEntry251"], build: "v1.5.69" },
  { dateKey: "changelog_2026_09_14", entries: ["changelogEntry250", "changelogEntry249", "changelogEntry248", "changelogEntry247", "changelogEntry246", "changelogEntry245"], build: "v1.5.68" },
  { dateKey: "changelog_2026_09_08", entries: ["changelogEntry244", "changelogEntry243"], build: "v1.5.62" },
  { dateKey: "changelog_2026_09_02", entries: ["changelogEntry242", "changelogEntry241", "changelogEntry240"], build: "v1.5.60" },
  { dateKey: "changelog_2026_09_01", entries: ["changelogEntry239", "changelogEntry238"], build: "v1.5.59" },
  { dateKey: "changelog_2026_08_31", entries: ["changelogEntry237"], build: "v1.5.57" },
  ...
  { dateKey: "changelog_2026_08_25", entries: ["changelogEntry232"], build: "v1.5.50" },
  { dateKey: "changelog_2026_08_25", entries: ["changelogEntry231"], build: "v1.5.49" },
  { dateKey: "changelog_2026_08_25", entries: ["changelogEntry230"], build: "v1.5.48" },

  { dateKey: "changelog_2026_08_23", entries: ["changelogEntry229"], build: "v1.5.47" },
  { dateKey: "changelog_2026_08_23", entries: ["changelogEntry228", "changelogEntry227", "changelogEntry226", "changelogEntry225", "changelogEntry224"], build: "v1.5.46" },
  { dateKey: "changelog_2026_08_22", entries: ["changelogEntry223"], build: "v1.5.41" },
  { dateKey: "changelog_2026_08_22", entries: ["changelogEntry222"], build: "v1.5.40" },
  { dateKey: "changelog_2026_08_22", entries: ["changelogEntry221"], build: "v1.5.39" },
  { dateKey: "changelog_2026_08_19", entries: ["changelogEntry220", "changelogEntry219"], build: "v1.5.38" },
  { dateKey: "changelog_2026_08_18", entries: ["changelogEntry218"], build: "v1.5.36" },
  { dateKey: "changelog_2026_08_17", entries: ["changelogEntry217"], build: "v1.5.35" },
  { dateKey: "changelog_2026_08_16", entries: ["changelogEntry216"], build: "v1.5.34" },
  { dateKey: "changelog_2026_08_16", entries: ["changelogEntry215"], build: "v1.5.33" },
  { dateKey: "changelog_2026_08_16", entries: ["changelogEntry214"], build: "v1.5.32" },
  { dateKey: "changelog_2026_08_13", entries: ["changelogEntry213"], build: "v1.5.31" },
  { dateKey: "changelog_2026_08_10", entries: ["changelogEntry212"], build: "v1.5.30" },
  { dateKey: "changelog_2026_08_08", entries: ["changelogEntry211"], build: "v1.5.29" },
  { dateKey: "changelog_2026_08_08", entries: ["changelogEntry210"], build: "v1.5.28" },
  { dateKey: "changelog_2026_08_08", entries: ["changelogEntry209"], build: "v1.5.27" },
  { dateKey: "changelog_2026_08_07", entries: ["changelogEntry208"], build: "v1.5.26" },
  { dateKey: "changelog_2026_08_07", entries: ["changelogEntry207"], build: "v1.5.25" },
  { dateKey: "changelog_2026_08_06", entries: ["changelogEntry206"], build: "v1.5.24" },
  { dateKey: "changelog_2026_08_06", entries: ["changelogEntry205"], build: "v1.5.23" },
  { dateKey: "changelog_2026_08_06", entries: ["changelogEntry204"], build: "v1.5.22" },
  { dateKey: "changelog_2026_08_06", entries: ["changelogEntry203"], build: "v1.5.20" },
  { dateKey: "changelog_2026_08_05", entries: ["changelogEntry201", "changelogEntry202"], build: "v1.5.19" },
 ...
 { dateKey: "changelog_2026_07_22", entries: ["changelogEntry179", "changelogEntry178"], build: "v1.4.3" },
 { dateKey: "changelog_2026_07_21", entries: ["changelogEntry177"], build: "v1.4.1" },
  { dateKey: "changelog_2026_07_16", entries: ["changelogEntry176"], build: "v1.4.0" },
  { dateKey: "changelog_2026_07_15", entries: ["changelogEntry175", "changelogEntry174"], build: "v1.3.9" },
  { dateKey: "changelog_2026_07_14", entries: ["changelogEntry173"], build: "v1.3.7" },
  ...
  { dateKey: "changelog_2026_07_28", entries: ["changelogEntry189"], build: "v1.5.8" },
  ...
  { dateKey: "changelog_2026_06_25", entries: ["changelogEntry155"], build: "v1.2.5" },
  { dateKey: "changelog_2026_06_23", entries: ["changelogEntry154", "changelogEntry153", "changelogEntry152"], build: "v1.2.4" },
  { dateKey: "changelog_2026_06_17", entries: ["changelogEntry151", "changelogEntry150", "changelogEntry149"], build: "v1.2.1" },
  { dateKey: "changelog_2026_06_12", entries: ["changelogEntry148", "changelogEntry147", "changelogEntry146"], build: "v1.2.0" },
  ...
  { dateKey: "changelog_2026_06_04", entries: ["changelogEntry139", "changelogEntry138", "changelogEntry137"], build: "v1.0.8" },
