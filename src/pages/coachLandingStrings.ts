...
const fa: CLStrings = {
  ...
  navForCoaches: "برای مربیان",
  navForAthletes: "برای ورزشکاران",
  navPricing: "قیمت‌ها",
  navLogin: "ورود",
  navGetStarted: "شروع کنید",

  heroBadge: "ساخته‌شده برای مربیان تکواندو",
  heroTitle: "به هر ورزشکار کوچ بده",
  heroPhrases: [
    "انگار وقت بیشتری داری.",
    "انگار تیمی پشت سرت داری.",
    "انگار همه‌چیز را قبلاً دیده‌ای.",
    "انگار بهترین فصل تو از همین حالا آغاز می‌شود.",
  ],
  heroDesc:
    "اسپورت‌تالنت ۲۰ سال دانش مربیگری تکواندو را در یک پلتفرم جمع کرده است — تا هر ورزشکار در باشگاهت توجهی که لایقش است را دریافت کند و تو وقت کمتری صرف کارهای اداری کنی.",
  heroCtaPrimary: "رایگان شروع کن",
  heroCtaSecondary: "ببین چطور کار می‌کند",
  heroFinePrint: "برای باشگاه‌های زیر ۱۰ ورزشکار در دوره آزمایشی رایگان · بدون نیاز به کارت اعتباری",

  mockSquadPulse: "نبض تیم",
  mockWeek: "هفته ۱۴ · ۱۸ ورزشکار",
  mockOnTrack: "در مسیر",
  mockSessionsLogged: "جلسات ثبت‌شده",
  mockThisWeek: "این هفته",
  mockAvgReadiness: "میانگین آمادگی",
  mockVsLast: "+۴ نسبت به قبل",
  mockWeeklyLoad: "بار هفتگی",
  mockTrimpDay: "TRIMP/روز",

  trustEyebrow: "مورد استفاده",
  trustLine: "مورد استفاده باشگاه‌های متخصص در مبارزه و پومسه — و طراحی‌شده برای استفاده هر باشگاهی.",

  featuresTitle1: "هرچه باشگاهت نیاز دارد.",
  featuresTitle2: "نه چیزی بیشتر.",
  features: [
    { title: "دستیار مربی", desc: "پیشنهاد جلسات، راهنمایی فنی و توصیه‌های تمرینی برگرفته از دانش عمیق رشته‌ای. مثل داشتن یک مربی دوم در سالن." },
    { title: "سازنده برنامه تمرینی", desc: "برنامه‌های دوره‌بندی‌شده برای هر سطح کمربند را در چند دقیقه بساز. متناسب با سن، تقویم مسابقات و اهداف فردی." },
    { title: "پیگیری پیشرفت ورزشکار", desc: "هر جلسه ثبت می‌شود. هر چک آمادگی ضبط می‌شود. الگوها را قبل از تبدیل‌شدن به آسیب شناسایی کن." },
    { title: "گزارش‌های هفتگی عملکرد", desc: "خلاصه‌ای روشن و قابل اشتراک از هفته هر ورزشکار — آماده برای والدین، مربیان کمکی یا فدراسیون." },
  ],

  howTitle: "چطور کار می‌کند",
  steps: [
    { title: "ورزشکارانت را اضافه کن", desc: "لیست باشگاه را در کمتر از ۵ دقیقه راه بینداز" },
    { title: "ورزشکاران تمرین خود را ثبت می‌کنند", desc: "نوع جلسه، شدت تلاش، حس آنها — ۶۰ ثانیه بعد از تمرین" },
    { title: "با وضوح کوچ کن", desc: "خلاصه‌های هفتگی، روندهای بار تمرینی و راهنمایی به‌صورت خودکار ظاهر می‌شوند تا تو روی تشک تمرکز کنی" },
  ],

  splitTitle: "ساخته‌شده برای هر دو طرف معادله",
  coachesLabel: "برای مربیان",
  coachesTitle: "تمام باشگاه را از یک صفحه مدیریت کن",
  coachFeatures: [
    "نمای کامل لیست همه ورزشکاران",
    "روندهای بار تمرینی و هشدارهای ریکاوری",
    "گزارش هفتگی هر ورزشکار با یک کلیک",
    "کتابخانه تمرین و تکنیک با بیش از ۱۰۰ مورد تخصصی تکواندو",
    "ابزارهای برنامه‌ریزی آماده‌سازی مسابقه",
  ],
  athletesLabel: "برای ورزشکاران",
  athletesTitle: "با ساختار و بازخورد تمرین کن",
  athleteFeatures: [
    "دفترچه تمرین شخصی",
    "چک آمادگی روزانه",
    "پیشرفت در طول زمان — کمربند به کمربند",
    "تمرکز تمرین این هفته از طرف مربی‌ات",
  ],

  testimonialsTitle: "مربیانی که تغییر دادند، برنگشتند",
  testimonials: [
    { stat: "۲۰ سال", quote: "بالاخره پلتفرمی که واقعاً تکواندو را می‌فهمد — نه فقط تناسب اندام عمومی.", name: "مربی سامی", club: "Klub i København" },
    { stat: "+۳ ساعت/هفته", quote: "ورزشکارانم خودشان جلسات را ثبت می‌کنند. هفته‌ای ۳ ساعت برایم آزاد می‌شود.", name: "مربی یانه", club: "Klub i Malmø" },
    { stat: "والدین همراه", quote: "همان گزارش هفتگی به‌تنهایی ارزشش را دارد. والدین بالاخره می‌فهمند چه چیزی می‌سازیم.", name: "مربی مایکل", club: "Klub i London" },
  ],

  pricingTitle: "قیمت‌گذاری ساده",
  pricingSub: "۱۴ روز آزمایش رایگان · بدون تعهد · لغو در هر زمان",
  ...
  prices: ["4.99", "12.99", "49", "89", "129"],
  tiers: [
    { name: "ورزشکار", desc: "برای ورزشکاران انفرادی", features: ["یک صندلی ورزشکار", "تمرین و پیشرفت پایه", "۱ برنامه فعال", "پیگیری ذهنی و ریکاوری"], cta: "شروع کنید" },
    { name: "Coach Solo", desc: "برای مربیان مستقل", features: ["صندلی مربی", "همه ماژول‌ها باز", "۱ برنامه فعال", "کتابخانه کامل عملکرد"], cta: "شروع کنید" },
    { name: "Team Small", desc: "تا ۵ ورزشکار", features: ["۵ صندلی ورزشکار", "همه ماژول‌ها باز", "برنامه‌های نامحدود", "ساخت برنامه گروهی", "نمای تیم"], cta: "آزمایش رایگان" },
    { name: "Team Medium", desc: "تا ۱۵ ورزشکار", features: ["۱۵ صندلی ورزشکار", "همه ماژول‌ها", "برنامه‌های نامحدود", "برنامه‌ریزی گروهی", "آنبوردینگ شامل"], cta: "آزمایش رایگان" },
    { name: "Team Large", desc: "تا ۲۵ ورزشکار", features: ["۲۵ صندلی ورزشکار", "همه ماژول‌ها", "برنامه‌های نامحدود", "آنبوردینگ", "پشتیبانی اولویت‌دار"], cta: "آزمایش رایگان" },
  ],
  pricingFootnoteLead: "همه برنامه‌ها و تخفیف‌های سالانه را ببینید در",
  pricingFootnoteLink: "صفحه قیمت‌ها",
  pricingFootnoteFedLead: "راه‌اندازی فدراسیون؟",
  pricingFootnoteContact: "با ما تماس بگیرید",

  finalCtaTitle: "قهرمان بعدی‌ات همین حالا در باشگاه توست.",
  finalCtaDesc: "به هر ورزشکار مربیگری‌ای که لایقش است را بده — بدون اینکه خودت را فرسوده کنی.",
  finalCtaButton: "همین امروز رایگان شروع کن",
  ...
  footerCols: [
    ...
    { title: "برای مربیان", links: [
      { label: "داشبورد مربی", href: "/platform/coach-dashboard" },
      { label: "سازنده برنامه", href: "/platform/plan-builder" },
      { label: "گزارش تیم", href: "/platform/squad-reports" },
      { label: "مدیریت لیست", href: "/platform/roster" },
      { label: "رزرو دمو", href: "/contact" },
    ] },
    { title: "برای ورزشکاران", links: [
      { label: "دفترچه روزانه", href: "/platform/diary" },
      { label: "چک آمادگی", href: "/platform/readiness" },
      { label: "پیگیری پیشرفت", href: "/platform/progress" },
      { label: "کتابخانه عملکرد", href: "/platform/library" },
      { label: "برنامه تغذیه", href: "/kostplan" },
    ] },
    { title: "شرکت", links: [
      { label: "درباره ما", href: "/about" },
      { label: "تماس", href: "/contact" },
      { label: "حریم خصوصی", href: "/privacy" },
      { label: "ورود", href: "/auth?tab=signin" },
      { label: "شروع رایگان", href: "/auth?tab=signup" },
    ] },
  ],
  footerCopy: "© 2025 Sportstalent.dk · ساخته‌شده برای تکواندو، توسط کسانی که عاشق این ورزش‌اند 🥋",
  footerPrivacy: "حریم خصوصی",
  footerContact: "تماس",
  galleryEyebrow: "ورزشکاران واقعی · لحظات واقعی",
  galleryTitle: "ساخته‌شده در کنار رینگ، نه پشت میز.",
  gallerySub: "از گوشه رینگ تا روی تشک — اسپورت‌تالنت از لحظاتی که مربیان و ورزشکاران هر آخر هفته تجربه می‌کنند شکل گرفته است.",
  storyRows: [
    { eyebrow: "در گوشه رینگ", title: "به هر ورزشکار کوچ بده انگار تنها ورزشکار توست.", body: "اسپورت‌تالنت برنامه ساختاریافته، داده‌های آمادگی و یادآورها را در اختیارت می‌گذارد تا گفت‌وگوی گوشه رینگ همیشه دقیق باشد — نه فی‌البداهه.", bullets: ["آمادگی روزانه از هر ورزشکار", "برنامه‌های هفتگی خودکار", "یک ضربه برای ثبت جلسه"] },
    { eyebrow: "روی تشک", title: "علم تخصصی رشته — نه تناسب اندام عمومی.", body: "برنامه‌ها بر اساس تکواندو ساخته شده‌اند: ضربات پا، کار پا، شدت‌های مبارزه و مدیریت وزن — متناسب با سن، کمربند و هدف.", bullets: ["برنامه‌های دوره‌بندی ۴ تا ۱۲ هفته‌ای", "مراحل پیش از، حین و پس از مسابقه", "تغذیه بدون گوشت خوک متناسب با وزن"] },
    { eyebrow: "قبل از مسابقه", title: "ببین چه کسی آماده است — و چه کسی نه.", body: "یک نمای تیم، خلق، انرژی، خواب و بار را برای هر ورزشکار نشان می‌دهد تا قبل از گرم‌کردن جلسه را تنظیم کنی، نه پس از باخت.", bullets: ["نبض تیم با وضعیت چراغ راهنما", "هشدار اور-تمرین دو هفته زودتر", "یادداشت‌های مربی هم‌گام با ورزشکار"] },
    { eyebrow: "بعد از مسابقه", title: "هر مسابقه را به درس تبدیل کن.", body: "بازاندیشی پس از مسابقه، تگ‌گذاری ویدیو و اهداف SMART تضمین می‌کنند چرخه تمرینی بعدی از همان جایی شروع شود که قبلی تمام شد.", bullets: ["بازاندیشی ۴ مرحله‌ای پس از هر مسابقه", "تگ‌های ویدیو بر اساس تکنیک و نتیجه", "۳ هدف SMART شخصی در هر چرخه"] },
  ],

  metaTitle: "اسپورت‌تالنت — پلتفرم مربیگری برای باشگاه‌های تکواندو",
  metaDesc:
    "پلتفرم مربیگری ساخته‌شده برای باشگاه‌های تکواندو. لیست تیم، آمادگی، برنامه‌های دوره‌بندی و گزارش‌های هفتگی — همه در یک جا.",
};

export const COACH_LANDING_STRINGS: Record<Locale, CLStrings> = { en, da, sv, no, de, ar, fa };
