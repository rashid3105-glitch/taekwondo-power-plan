...
const en: CLStrings = {
  ...
  currency: "",
  tiers: [
    { name: "Club", desc: "Up to 50 members · 7.500 DKK/year excl. VAT (9.375 incl. VAT)", features: ["All modules unlocked", "Unlimited plans", "Bulk plan creation", "Squad overview", "Weekly per-athlete reports"], cta: "Contact us" },
    { name: "Club Plus", desc: "51-120 members · 12.000 DKK/year excl. VAT (15.000 incl. VAT)", features: ["Everything in Club", "Priority support", "Advanced video analysis", "Multiple squads", "Advanced reports"], cta: "Contact us" },
    { name: "Large Club", desc: "121-250 members · 18.000 DKK/year excl. VAT (22.500 incl. VAT)", features: ["Everything in Club Plus", "Multiple coach teams", "Onboarding included", "Priority support", "Scalable setup"], cta: "Contact us" },
    { name: "Larger club", desc: "More than 250 members", features: ["All modules", "Unlimited plans", "Onboarding included", "Priority support", "Scalable setup"], cta: "Contact us" },
  ],
...
const sv: CLStrings = {
  ...
  currency: "",
  tiers: [
    { name: "Klubb", desc: "Upp till 50 medlemmar · 7.500 kr/år exkl. moms (9.375 kr inkl. moms)", features: ["Alla moduler upplåsta", "Obegränsade planer", "Bulkplanering", "Lagöversikt", "Veckorapporter per atlet"], cta: "Kontakta oss" },
    { name: "Klubb Plus", desc: "51-120 medlemmar · 12.000 kr/år exkl. moms (15.000 kr inkl. moms)", features: ["Allt i Klubb", "Prioriterad support", "Avancerad videoanalys", "Flera lag", "Avancerade rapporter"], cta: "Kontakta oss" },
    { name: "Klubb Stor", desc: "121-250 medlemmar · 18.000 kr/år exkl. moms (22.500 kr inkl. moms)", features: ["Allt i Klubb Plus", "Flera tränarteam", "Onboarding ingår", "Prioriterad support", "Skalbar uppsättning"], cta: "Kontakta oss" },
    { name: "Större klubb", desc: "Över 250 medlemmar", features: ["Alla moduler", "Obegränsade planer", "Onboarding ingår", "Prioriterad support", "Skalbar uppsättning"], cta: "Kontakta oss" },
  ],
...
const de: CLStrings = {
  ...
  currency: "",
  tiers: [
    { name: "Verein", desc: "Bis zu 50 Mitglieder · 7.500 DKK/Jahr zzgl. MwSt. (9.375 DKK inkl. MwSt.)", features: ["Alle Module freigeschaltet", "Unbegrenzte Pläne", "Bulk-Planerstellung", "Kaderübersicht", "Wöchentliche Berichte pro Athlet"], cta: "Kontaktiert uns" },
    { name: "Verein Plus", desc: "51-120 Mitglieder · 12.000 DKK/Jahr zzgl. MwSt. (15.000 DKK inkl. MwSt.)", features: ["Alles im Verein", "Priorisierter Support", "Erweiterte Videoanalyse", "Mehrere Teams", "Erweiterte Berichte"], cta: "Kontaktiert uns" },
    { name: "Verein Groß", desc: "121-250 Mitglieder · 18.000 DKK/Jahr zzgl. MwSt. (22.500 DKK inkl. MwSt.)", features: ["Alles in Verein Plus", "Mehrere Trainerteams", "Onboarding inklusive", "Priorisierter Support", "Skalierbares Setup"], cta: "Kontaktiert uns" },
    { name: "Größerer Verein", desc: "Über 250 Mitglieder", features: ["Alle Module", "Unbegrenzte Pläne", "Onboarding inklusive", "Priorisierter Support", "Skalierbares Setup"], cta: "Kontaktiert uns" },
  ],
...
const ar: CLStrings = {
  ...
  currency: "",
  tiers: [
    { name: "نادٍ", desc: "حتى 50 عضوًا · 7.500 كرونة/سنة بدون ضريبة القيمة المضافة (9.375 شاملة الضريبة)", features: ["جميع الوحدات مفتوحة", "خطط غير محدودة", "إنشاء خطط بالجملة", "نظرة عامة على الفريق", "تقارير أسبوعية لكل رياضي"], cta: "تواصلوا معنا" },
    { name: "نادٍ بلس", desc: "51-120 عضو · 12.000 كرونة/سنة بدون ضريبة القيمة المضافة (15.000 شاملة الضريبة)", features: ["كل ما في النادي", "دعم ذو أولوية", "تحليل فيديو متقدم", "عدة فرق", "تقارير متقدمة"], cta: "تواصلوا معنا" },
    { name: "نادٍ كبير", desc: "121-250 عضو · 18.000 كرونة/سنة بدون ضريبة القيمة المضافة (22.500 شاملة الضريبة)", features: ["كل ما في نادٍ بلس", "عدة فرق تدريب", "إعداد مشمول", "دعم ذو أولوية", "إعداد قابل للتوسع"], cta: "تواصلوا معنا" },
    { name: "نادٍ أكبر", desc: "أكثر من 250 عضو", features: ["جميع الوحدات", "خطط غير محدودة", "إعداد مشمول", "دعم ذو أولوية", "إعداد قابل للتوسع"], cta: "تواصلوا معنا" },
  ],
...
const es: CLStrings = {
  ...
  currency: "",
  tiers: [
    { name: "Club", desc: "Hasta 50 miembros · 7.500 DKK/año sin IVA (9.375 DKK con IVA)", features: ["Todos los módulos desbloqueados", "Planes ilimitados", "Creación de planes en grupo", "Vista general del equipo", "Informes semanales por atleta"], cta: "Contactad con nosotros" },
    { name: "Club Plus", desc: "51-120 miembros · 12.000 DKK/año sin IVA (15.000 DKK con IVA)", features: ["Todo en Club", "Soporte prioritario", "Análisis de vídeo avanzado", "Varios equipos", "Informes avanzados"], cta: "Contactad con nosotros" },
    { name: "Club Grande", desc: "121-250 miembros · 18.000 DKK/año sin IVA (22.500 DKK con IVA)", features: ["Todo en Club Plus", "Varios equipos de entrenadores", "Incorporación incluida", "Soporte prioritario", "Configuración escalable"], cta: "Contactad con nosotros" },
    { name: "Club grande", desc: "Más de 250 miembros", features: ["Todos los módulos", "Planes ilimitados", "Incorporación incluida", "Soporte prioritario", "Configuración escalable"], cta: "Contactad con nosotros" },
  ],
