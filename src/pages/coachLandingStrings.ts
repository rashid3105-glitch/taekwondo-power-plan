...
const en: CLStrings = {
  ...
  tiers: [
    ...
    { name: "Club Plus", desc: "51-120 members · 12.000 DKK/year", features: ["Everything in Club", "Priority support", "Advanced video analysis", "Multiple squads", "Advanced reports"], cta: "Contact us" },
    { name: "Large Club", desc: "121-250 members · 18.000 DKK/year", features: ["Everything in Club Plus", "Multiple coach teams", "Onboarding included", "Priority support", "Scalable setup"], cta: "Contact us" },
...
const da: CLStrings = {
  ...
  tiers: [
    ...
    { name: "Klub Plus", desc: "51-120 medlemmer · 12.000 kr/år", features: ["Alt i Klub", "Prioritetssupport", "Udvidet videoanalyse", "Flere hold", "Avancerede rapporter"], cta: "Kontakt os" },
    { name: "Klub Stor", desc: "121-250 medlemmer · 18.000 kr/år", features: ["Alt i Klub Plus", "Flere trænerteams", "Onboarding inkluderet", "Prioritetssupport", "Skalérbar opsætning"], cta: "Kontakt os" },
...
const sv: CLStrings = {
  ...
  tiers: [
    ...
    { name: "Klubb Plus", desc: "51-120 medlemmar · 12.000 kr/år", features: ["Allt i Klubb", "Prioriterad support", "Avancerad videoanalys", "Flera lag", "Avancerade rapporter"], cta: "Kontakta oss" },
    { name: "Klubb Stor", desc: "121-250 medlemmar · 18.000 kr/år", features: ["Allt i Klubb Plus", "Flera tränarteam", "Onboarding ingår", "Prioriterad support", "Skalbar uppsättning"], cta: "Kontakta oss" },
...
const de: CLStrings = {
  ...
  tiers: [
    ...
    { name: "Verein Plus", desc: "51-120 Mitglieder · 12.000 DKK/Jahr", features: ["Alles im Verein", "Priorisierter Support", "Erweiterte Videoanalyse", "Mehrere Teams", "Erweiterte Berichte"], cta: "Kontaktiert uns" },
    { name: "Verein Groß", desc: "121-250 Mitglieder · 18.000 DKK/Jahr", features: ["Alles in Verein Plus", "Mehrere Trainerteams", "Onboarding inklusive", "Priorisierter Support", "Skalierbares Setup"], cta: "Kontaktiert uns" },
...
const ar: CLStrings = {
  ...
  tiers: [
    ...
    { name: "نادٍ بلس", desc: "51-120 عضو · 12.000 كرونة/سنة", features: ["كل ما في النادي", "دعم ذو أولوية", "تحليل فيديو متقدم", "عدة فرق", "تقارير متقدمة"], cta: "تواصلوا معنا" },
    { name: "نادٍ كبير", desc: "121-250 عضو · 18.000 كرونة/سنة", features: ["كل ما في نادٍ بلس", "عدة فرق تدريب", "إعداد مشمول", "دعم ذو أولوية", "إعداد قابل للتوسع"], cta: "تواصلوا معنا" },
...
const es: CLStrings = {
  ...
  tiers: [
    ...
    { name: "Club Plus", desc: "51-120 miembros · 12.000 DKK/año", features: ["Todo en Club", "Soporte prioritario", "Análisis de vídeo avanzado", "Varios equipos", "Informes avanzados"], cta: "Contactad con nosotros" },
    { name: "Club Grande", desc: "121-250 miembros · 18.000 DKK/año", features: ["Todo en Club Plus", "Varios equipos de entrenadores", "Incorporación incluida", "Soporte prioritario", "Configuración escalable"], cta: "Contactad con nosotros" },
