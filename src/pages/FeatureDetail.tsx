...
const features: Record<FeatureKey, FeatureData> = {
  plan: {
    ...
    longDesc: {
      en: "Our programs are rooted in proven periodization science — the same methodology used by elite coaches worldwide. Based on your event calendar, weekly schedule, training goals, and current injuries, we build a fully periodized strength & conditioning program. Each session is designed to complement your sport-specific training — not compete with it.",
      da: "Vores programmer er baseret på gennemprøvet periodiseringsvidenskab — den samme metodik brugt af elitetrænere verden over. Baseret på din kalender, ugentlige skema, træningsmål og nuværende skader bygger vi et fuldt periodiseret styrke- og konditionsprogram. Hver session er designet til at supplere din sportsspecifikke træning — ikke konkurrere med den.",
      sv: "Våra program är grundade i beprövad periodiseringsvetenskap — samma metodik som används av elittränare världen över. Baserat på din kalender, veckoschema, träningsmål och nuvarande skador bygger vi ett fullt periodiserat styrke- och konditionsprogram. Varje pass är utformat för att komplettera din sportspecifika träning — inte konkurrera med den.",
      de: "Unsere Programme basieren auf bewährter Periodisierungswissenschaft — dieselbe Methodik, die von Elite-Trainern weltweit verwendet wird. Basierend auf Ihrem Kalender, Wochenplan, Trainingszielen und aktuellen Verletzungen erstellen wir ein vollständig periodisiertes Kraft- und Konditionsprogramm. Jede Einheit ergänzt Ihr sportspezifisches Training — sie konkurriert nicht damit.",
      ar: "تستند برامجنا إلى علم التقسيم الدوري المثبت — نفس المنهجية المستخدمة من قبل المدربين النخبة حول العالم. بناءً على تقويمك وجدولك الأسبوعي وأهدافك التدريبية وإصاباتك الحالية، نبني برنامج قوة ولياقة مقسم دوريًا بالكامل. كل جلسة مصممة لتكمل تدريبك الرياضي المتخصص — وليس للتنافس معه.",
    },
    benefits: [
      ...
      { en: "Tailored to your training level and goals", da: "Skræddersyet til dit træningsniveau og mål", sv: "Anpassat till din träningsnivå och mål", de: "Angepasst an Ihr Trainingsniveau und Ihre Ziele", ar: "مصممة حسب مستوى تدريبك وأهدافك" },
  ...
  mental: {
    ...
    longDesc: {
      en: "Mental strength separates good athletes from great ones. Assess your psychological readiness with our sports psychology framework, then receive personalized advice covering focus, visualization, competition anxiety, and more — built on the same principles used by elite sports psychologists.",
      da: "Mental styrke adskiller gode atleter fra de bedste. Vurder din psykologiske parathed med vores sportspsykologiske rammeværk, og modtag derefter personlig rådgivning om fokus, visualisering, konkurrenceangst og mere — bygget på de samme principper brugt inden for elitesport.",
      sv: "Mental styrka skiljer bra atleter från de bästa. Bedöm din psykologiska beredskap med vårt idrottspsykologiska ramverk och få personlig rådgivning om fokus, visualisering, tävlingsångest och mer — byggt på samma principer som används inom elitidrott.",
  ...
  rehab: {
    ...
    longDesc: {
      en: "Injuries don't have to derail your training. Describe your injury and receive a phased rehabilitation program with clear pain guidelines, progression milestones, and safety protocols — designed specifically for club athletes returning to play.",
      da: "Skader behøver ikke at afspore din træning. Beskriv din skade og modtag et fasebaseret rehabiliteringsprogram med klare smerteretningslinjer, progressionsmilepæle og sikkerhedsprotokoller — designet specifikt til klubatleter, der vender tilbage til konkurrence.",
      sv: "Skador behöver inte spåra ur din träning. Beskriv din skada och få ett fasindelat rehabiliteringsprogram med tydliga smärtriktlinjer, progressionsmilstolpar och säkerhetsprotokoll — designat specifikt för klubbatleter som återvänder till tävling.",
      ...
      ar: "الإصابات لا يجب أن تعرقل تدريبك. صِف إصابتك واحصل على برنامج إعادة تأهيل مرحلي مع إرشادات واضحة للألم ومعالم تقدم وبروتوكولات سلامة — مصمم خصيصًا لرياضيي الأندية العائدين إلى الملعب.",
    },
    benefits: [
      ...
      { en: "Sport-specific recovery protocols", da: "Sportsspecifikke genoptræningsprotokoller", sv: "Sportspecifika återhämtningsprotokoll", de: "Sportartspezifische Erholungsprotokolle", ar: "بروتوكولات استشفاء خاصة بالرياضة" },
  ...
  nutrition: {
    ...
    longDesc: {
      en: "Fuel your performance with athlete-friendly nutrition. Browse curated recipes with full macro breakdowns, or generate a complete meal plan tailored to your weight, training load, and competition schedule — based on sports nutrition principles for elite club athletes.",
      da: "Fuel din præstation med atletvenlig ernæring. Gennemse kuraterede opskrifter med fuld makronedbrydning, eller generer en komplet kostplan skræddersyet til din vægt, træningsmængde og konkurrencekalender — baseret på sportsernæringsprincipper for elite klubatleter.",
      sv: "Driva din prestation med atletvänlig näring. Bläddra bland kurerade recept med full makronedbrytning, eller generera en komplett kostplan anpassad till din vikt, träningsbelastning och tävlingsschema — baserad på idrottsnäringsprinciper för elitklubbatleter.",
      ...
      ar: "عزز أداءك بتغذية مناسبة للرياضيين. تصفح وصفات منتقاة مع تفاصيل كاملة للماكرو، أو أنشئ خطة وجبات كاملة مصممة حسب وزنك وحمل التدريب وجدول المنافسات — بناءً على مبادئ التغذية الرياضية لرياضيي النخبة في الأندية.",
    },
    benefits: [
  ...
  library: {
    ...
    longDesc: {
      en: "Access a curated collection of sport-specific exercises, each with detailed instructions, muscle group targeting, tempo guides, and video references. Every exercise is selected for its relevance to elite athletic performance — from explosive hip power to rotational core stability.",
      da: "Få adgang til en kurateret samling af sportsspecifikke øvelser, hver med detaljerede instruktioner, muskelgruppemålretning, tempoguider og videoreferencer. Hver øvelse er udvalgt for sin relevans for atletisk præstation — fra eksplosiv hoftekraft til rotationel core-stabilitet.",
      sv: "Få tillgång till en kurerad samling sportspecifika övningar, var och en med detaljerade instruktioner, muskelgruppsmålning, tempoguider och videoreferenser. Varje övning är utvald för sin relevans för atletisk prestation — från explosiv höftkraft till rotationell core-stabilitet.",
      de: "Greifen Sie auf eine kuratierte Sammlung sportartspezifischer Übungen zu, jede mit detaillierten Anleitungen, Muskelgruppen-Targeting, Tempo-Leitfäden und Videoreferenzen. Jede Übung ist für ihre Relevanz für die athletische Leistung ausgewählt.",
      ar: "احصل على مجموعة منتقاة من التمارين الرياضية المتخصصة، كل منها مع تعليمات مفصلة واستهداف مجموعات العضلات وأدلة الإيقاع ومراجع الفيديو. كل تمرين مختار لأهميته في الأداء الرياضي — من قوة الورك الانفجارية إلى ثبات الجذع الدوراني.",
    },
    benefits: [
      { en: "Curated sport-specific exercises", da: "Kuraterede sportsspecifikke øvelser", sv: "Kurerade sportspecifika övningar", de: "Kuratierte sportartspezifische Übungen", ar: "تمارين منتقاة خاصة بالرياضة" },
