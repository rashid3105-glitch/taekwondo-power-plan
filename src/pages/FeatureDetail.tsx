...
const features: Record<FeatureKey, FeatureData> = {
  plan: {
    ...
    longDesc: {
      en: "Our programs are rooted in proven periodization science — the same methodology used by elite coaches worldwide. Based on your belt level, weekly schedule, training goals, and current injuries, we build a fully periodized strength & conditioning program. Each session is designed to complement your sport-specific training — not compete with it.",
