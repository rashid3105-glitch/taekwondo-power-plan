...
import { ArrowRight, Dumbbell, Shield, Flame, Moon, Calendar, Zap, Target, TrendingUp, CheckCircle2, ChevronRight } from "lucide-react";
...
const TrainingProgram = () => {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col relative">
      <PageMeta
        title="AI Training Plans for Taekwondo Athletes — Strength & Conditioning Programs"
          ...
          <div className="relative max-w-3xl mx-auto px-5 pt-14 pb-10 sm:pt-20 sm:pb-14">
            ...
            >
              ...
              <span className="text-[10px] font-semibold uppercase tracking-[0.15em] text-muted-foreground">
                Sport Science · AI-Powered · TKD Specific
              </span>
            </motion.div>
        ...
        <section className="max-w-3xl mx-auto px-5 pb-16 sm:pb-20">
          ...
          >
            ...
            <p className="mt-3 text-[11px] text-muted-foreground/60">
              Used by competitive athletes from cadet to senior level
            </p>
          </motion.div>
        </section>
      </main>
