...
export default function SeasonCalendar() {
  ...
  // The per-day session template is stored per season plan in club_season_day_templates
  // and edited in the WeekTemplateEditor below. It is the same source the athletes read,
  // so coach and athlete calendars always show identical sessions.
  useEffect(() => { setTemplate([]); }, [selectedPlanId]);
