  ...
  return (
    <div style={{ background: "#0B0C14", color: "#fff", fontFamily: "Inter, sans-serif", overflowX: "hidden" }}>
      ...
      <section style={{ padding: `${isMobile ? 48 : 72}px ${pad}px 0`, textAlign: "center" }}>
        ...
        <h1 style={{ fontSize: "clamp(30px,6vw,62px)", fontWeight: 900, lineHeight: 1.07, letterSpacing: "-0.04em", margin: "0 0 20px" }}>
          Platformen der løfter<br /><span style={{ color: "#F5C842" }}>talenter</span> til champions
        </h1>
        <p style={{ fontSize: isMobile ? 15 : 17, color: "rgba(255,255,255,0.5)", lineHeight: 1.65, maxWidth: 500, margin: "0 auto 36px" }}>
      ...
      <div style={{ background: "#13141F", borderTop: "0.5px solid rgba(255,255,255,0.07)", borderBottom: "0.5px solid rgba(255,255,255,0.07)", marginTop: 0 }}>
        <div style={{ maxWidth: 760, margin: "0 auto", padding: `${isMobile ? 48 : 64}px ${pad}px`, textAlign: "center" }}>
      ...
      {/* FEATURES */}
      <div style={{ maxWidth: 1000, margin: "0 auto", padding: `${isMobile ? 48 : 72}px ${pad}px` }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr 1fr" : "repeat(auto-fit,minmax(200px,1fr))", gap: 12 }}>
          {[
            ...
            <div key={i} style={{ background: "rgba(255,255,255,0.03)", border: "0.5px solid rgba(255,255,255,0.07)", borderRadius: 14, padding: isMobile ? "16px 14px" : "20px 18px" }}>
      ...
      <div style={{ background: "#13141F", borderTop: "0.5px solid rgba(255,255,255,0.07)", borderBottom: "0.5px solid rgba(255,255,255,0.07)" }}>
        <div style={{ maxWidth: 1000, margin: "0 auto", padding: `${isMobile ? 48 : 72}px ${pad}px`, display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr", gap: isMobile ? 32 : 56, alignItems: "center" }}>
          <div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 20 }}>
              {[
                ...
                <div key={i}>
                  <div style={{ fontSize: 20, marginBottom: 6 }}>{w2.icon}</div>
                  <div style={{ fontSize: 13, fontWeight: 700, marginBottom: 4 }}>{w2.t}</div>
                  <div style={{ fontSize: 12, color: "rgba(255,255,255,0.4)", lineHeight: 1.5 }}>{w2.d}</div>
                </div>
              ))}
            </div>
          </div>
      ...
      {/* FOUNDER */}
      <div style={{ background: "#13141F", borderTop: "0.5px solid rgba(255,255,255,0.07)", borderBottom: "0.5px solid rgba(255,255,255,0.07)" }}>
        <div style={{ maxWidth: 1000, margin: "0 auto", padding: `${isMobile ? 48 : 72}px ${pad}px`, display: "grid", gridTemplateColumns: isMobile ? "1fr" : "auto 1fr", gap: isMobile ? 28 : 48, alignItems: "start", justifyItems: isMobile ? "center" : "start", textAlign: isMobile ? "center" : "left" }}>
          ...
          <div>
            ...
            <div style={{ borderLeft: isMobile ? "none" : "3px solid #F5C842", paddingLeft: isMobile ? 0 : 18, marginBottom: 16 }}>
      ...
      {/* CTA */}
      <div style={{ background: "#13141F", borderTop: "0.5px solid rgba(255,255,255,0.07)", padding: `${isMobile ? 48 : 72}px ${pad}px`, textAlign: "center" }}>
        <h2 style={{ fontSize: "clamp(24px,4vw,44px)", fontWeight: 900, letterSpacing: "-0.03em", marginBottom: 14, lineHeight: 1.1 }}>Giv dine atleter den<br />platform de fortjener</h2>
        <p style={{ fontSize: 16, color: "rgba(255,255,255,0.45)", maxWidth: 440, margin: "0 auto 32px", lineHeight: 1.65 }}>Slut dig til de mange coaches der allerede bruger Sportstalent til at udvikle talenter smartere.</p>
