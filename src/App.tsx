  ...
  return (
    ...
    <AnimatePresence mode="wait" initial={false}>
      <Routes location={location} key={location.pathname}>
        ...
        <Route path="/priser" element={isNativeApp() ? <Navigate to="/dashboard" replace /> : <Page><PublicSeo path="/priser" title="Priser — klublicens til sportsklubber | Sportstalent" description="Én fast årspris for hele klubben: fra 7.500 kr. for op til 50 medlemmer til 18.000 kr. for 121-250. Ekskl. moms, faktureret årligt. Atleter og forældre betaler ingenting." /><Priser /></Page>} />
        ...
        <Route path="/admin/leads" element={<Page><AdminLeads /></Page>} />
        ...
        <Route path="/coach/logs" element={<Page><CoachLogs /></Page>} />
