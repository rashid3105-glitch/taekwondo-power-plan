...
export function HubOtherModules({ isDemo, isLocked, onTab }: Props) {
  ...
  const chips = [
    ...
    { key: "nutrition", icon: Apple, label: t("nutrition"), color: "text-tab-nutrition", bg: "bg-tab-nutrition/10 border-tab-nutrition/30", onClick: () => navigate("/library/nutrition"), locked: isDemo, hasNew: true },
