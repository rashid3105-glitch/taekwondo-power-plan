...
const translations = {
  en: {
    ...
    rehabProgress: "Rehab Progress",
    activeRehabPlan: "Active Plan",
    rehabPhases: "Phases",
    noRehabData: "No rehab plans yet.",
    none: "None",
  ...
  da: {
    ...
    rehabProgress: "Genoptræningsfremgang",
    activeRehabPlan: "Aktiv plan",
    rehabPhases: "Faser",
    noRehabData: "Ingen genoptræningsplaner endnu.",
    none: "Ingen",
